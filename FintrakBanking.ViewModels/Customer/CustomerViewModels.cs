...
namespace FintrakBanking.ViewModels.Customer
{
    public class CustomerViewModels : GeneralEntity
    {
        ...
        public CustomerViewModels()
        {
            ...
            CustomerNextOfKin = new List<CustomerNextOfKinViewModels>();
            ...
            getcustomeracctsdetailsresp = new List<GetCustomerAcctsDetailsResp>();
        }
        ...
        public List<CustomerNextOfKinViewModels> CustomerNextOfKin { get; set; }
    ...
    {
        string AccountClassType { get; set; }
        ...
        public DateTime? dAUEStartDate { get; set; }
        ...
        public string authstatusFlag { get; set; }
        public string recordstatusFlag { get; set; }
        public int customerTypeId { get; set; }
        public string companyName { get; set; }
        public string company_name { get; set; }
        public bool isPoliticallyExposed { get; set; }
        public int politicallyExposedPerson { get; set; }
    ...
    public class getacctsummarybycustomernosresp
    {
        public string AccountName { get; set; }
        public string AccountNo { get; set; }
        public DateTime? AccountOpenDate { get; set; }
        public string AccountStatus { get; set; }
        public decimal? AcctOpeningBalance { get; set; }
        public decimal? AmountBlocked { get; set; }
        public decimal? amt_od_limit { get; set; }
        public decimal? AvailableBalance { get; set; }
        ...
        public string CustID { get; set; }
        public int? HasCOT { get; set; }
        public int hasImage { get; set; }
        public string IsStaff { get; set; }
        public string LoanStatus { get; set; }
        public decimal? Lodgement { get; set; }
        public decimal? NetBalance { get; set; }
        public string ProductCode { get; set; }
        ...
        public string CustomerSegment { get; set; }
        public string hasFixedDeposit { get; set; }
    ...
    public class CFLNotifyResponse
    {
