...
public class LienProcessViewModel //: GeneralEntity
    ...
    public class ResponseMessageViewModel
    {
        ...
        public string responseBoCode { get; set; }
    ...
    public class TDAccountRecordViewModel
    {
        ...
        public List<FixedDepositInfo> FixedDepositInfo { get; set; }
        public string response_code { get; set; }
        public string response_message { get; set; }
        public string contract_status { get; set; }
        public string rollover_allowed { get; set; }
        public decimal? maturity_amount { get; set; }
        public string settlementacct_brcode { get; set; }
        public string customer_name { get; set; }
        public string branch_code { get; set; }
        public DateTime? book_date { get; set; }
        public string deposit_ccycode { get; set; }
        public string payment_method { get; set; }
        public string product { get; set; }
        public string settlementacct_ccycode { get; set; }
    ...
    public class ResponseMessage
    {
        ...
        public CFLNotifyResponse CFLNotifyResponse { get; set; }
