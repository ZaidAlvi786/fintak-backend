...
namespace FintrakBanking.Interfaces.Admin
{
    public interface IAdminRepository
    {
        ...
        Task<bool> isStaffExist(long staffId);
        ...
        Task<GlobalSettingViewModel> GetAllGlobalSettings();

        Task<AppGroupViewModel> GetSingleGroup(int groupId);
        ...
        Task<bool> deleteGroup(short groupId, AppGroupViewModel groupModel);
        ...
        Task<bool> StaffHasActivity(int staffId, string activity);
