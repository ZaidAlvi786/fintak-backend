   ...
   public interface ICustomerStagingRepository
    {
        ...
        Task<List<CustomerViewModels>> GetIntegratedCustomerInformation(string searchTerm, bool isProspectConversion);
        ...
        Task<bool> MergeDuplicateCustomers(string accounNumber, string prospectiveCustomerCode, int createdBy);
