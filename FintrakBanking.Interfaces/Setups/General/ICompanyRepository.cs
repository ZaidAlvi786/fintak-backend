...
namespace FintrakBanking.Interfaces.Setups.General
{
    public interface ICompanyRepository
    {
        ...
        Task<IEnumerable<CompanyDirectorsViewModel>> GetCompanyDirectors();
        Task<IEnumerable<LookupViewModel>> GetCompanyDirectorsByCompanyId(int companyId);
        bool AddUpdateCompanyDirector(CompanyDirectorsViewModel director);
        Task<IEnumerable<CompanyDirectorsViewModel>> GetCustomerCompanyDirectorsByCompanyId(int companyId);
