...
namespace FintrakBanking.Interfaces.Setups.General
{
    public interface IProductRepository
    {
        ...
        Task<IEnumerable<LookupViewModel>> GetProductClassByProcessId(int processId);
        ...
        Task<IEnumerable<LookupViewModel>> GetAllCRMSType(int companyId);
        Task<IEnumerable<LookupViewModel>> GetAllRiskRatingType(int companyId);

        Task<ProductBehaviourViewModel> GetProductBehaviour(int productId);

        // IEnumerable<ProductPriceIndexViewModel> GetAllProductPriceIndexByCurrencyId(int currencyId);
       Task<ProductPriceIndexViewModel> GetProductPriceIndexByProductId(int productId);
        ...
        Task<ProductViewModel> GetTempProductDetail(int productId);
        ...
        Task<IEnumerable<ProductViewModel>> GetAllProductByProductClass(int productClassId, int customerTypeId);
        IEnumerable<ProductViewModel> GetAllProductByProductClassAndCustomerType(int productClassId, int customerTypeId);
        Task<IEnumerable<ProductViewModel>> GetAllProductsByProductClassIdAndCustomerTypeId(int productClassId, int customerTypeId);
        Task<IEnumerable<LookupViewModel>> GetProductCurrency(int productId);
        ...
        Task<ProductPriceIndexViewModel> GetAllProductPriceIndicesById(int priceIndexId);
        ...
        Task<IEnumerable<ProductClassProcessViewModel>> GetAllProductClassProcesses();
        ...
        Task<IEnumerable<ProductClassificationViewModel>> GetAllProductClassification();
       ...
       Task< IEnumerable<ProductLiteViewModel>> GetAllProductLite();
        ...
        Task<IEnumerable<ProductDocumentMappingViewModel>> GetAllProductDocumentMapping();
        bool DeleteProductDocumentMapping(int id);  
        bool UpdateProductDocumentMapping(ProductDocumentMappingViewModel model);

        Task<ProductDocumentMappingViewModel> GetProductDocumenetMapping(int Id);
    }
}