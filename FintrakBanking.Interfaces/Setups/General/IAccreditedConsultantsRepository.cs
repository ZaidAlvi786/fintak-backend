...
namespace FintrakBanking.Interfaces.Setups.General
{
   public interface IAccreditedConsultantsRepository
    {
        //Solicitor
        Task<IEnumerable<AccreditedConsultantsViewModel>> GetSearchedAgent(string search);
        Task<IEnumerable<AccreditedConsultantsViewModel>> GetAccreditedConsultants(int companyId);
        Task<IEnumerable<AccreditedConsultantsViewModel>> GetAccreditedStateConsultants(int getCompanyId);
        Task<IEnumerable<AccreditedConsultantsViewModel>> GetAccreditedStateConsultantsByStateId(int companyId, int stateId);
        ...
        Task<bool> AddConsultantType(AccreditedConsultantTypeViewModel entity);
        ...
        Task<bool> RemoveLoanConsultant(int id, UserInfo user);
        Task<List<LoanConsultantViewModel>> GetLoanConsultant(int applicationId);
