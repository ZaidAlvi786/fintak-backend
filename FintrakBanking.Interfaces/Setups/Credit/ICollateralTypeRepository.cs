...
namespace FintrakBanking.Interfaces.Setups.Credit
{
    public interface ICollateralTypeRepository
    {
        ...
        Task<IEnumerable<CollateralDocumentTypeViewModel>> GetCollateralDocumentTypes(int id);
        Task<bool> AddCollateralDocumentType(CollateralDocumentTypeViewModel entity);

        IEnumerable<CollateralTypeViewModel> GetCollateralTypes();
        CollateralTypeViewModel GetCollateralTypesById(int typeId);
        Task<IEnumerable<CollateralTypeViewModel>> CollateralTypesByLoanApplication(int? id);

        #endregion End of Collateral Types


        #region Collateral SubTypes
        Task<IEnumerable<CollateralSubTypeViewModel>> GetCollateralSubTypes();
        Task<CollateralSubTypeViewModel> CollateralSubType(int Id);
        Task<IEnumerable<CollateralSubTypeViewModel>> GetCollateralSubTypeByCollateralTypeId(short collateralTypeId);
        ...
        Task<bool> UpdateCollateralSubTypes(int subTypeId, CollateralSubTypeViewModel entity);
