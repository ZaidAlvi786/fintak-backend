...
namespace FintrakBanking.Interfaces.Credit
{
    public interface IIntegrationWithFinacle
    {
        ...
        List<CustomerTurnoverViewModel> GetCustomerAccountTurnover(string customerCode, DateTime startDate, DateTime endDate);
...
<!-- Auto-push timestamp: 2026-05-21 12:37:14 -->