    ...
    namespace OverDraftTransactions
    {
        public class OverDraft
        {
            ...
            public async Task<ResponseMessage> FlexcubeAPIOverDraft(FlexcubeCreateOverdraftViewModel model, short loanSystemTypeId)
            {
                ...
                List<FlexcubeCreateOverdraftViewModel> rec = new List<FlexcubeCreateOverdraftViewModel>();
                FlexcubeCreateOverdraftViewModel reqbody = null;
                ResponseMessageOverDraftViewModel responseAPI = new ResponseMessageOverDraftViewModel();
                FlexcubeCreateOverdraftViewModel responbody = new FlexcubeCreateOverdraftViewModel();

                               
                                
                getAPIURLSettings("OverdraftWithoutLien");
                var baseURL = API_URL;
                string fullURL = baseURL + "FCUBSCreateOverdraftWithoutLien";
                RestClient client = new RestClient(fullURL);

                try
                {
                    reqbody = new FlexcubeCreateOverdraftViewModel()
                    {

                        channel_code = "FINTRAK",
                        account_no = model.account_no,
                        collateral_code = model.collateral_code,
                        collateral_value = model.collateral_value,
                    ...
                    response = await client.ExecutePostAsync<FlexcubeCreateOverdraftViewModel>(req);
                    responbody = JsonConvert.DeserializeObject<FlexcubeCreateOverdraftViewModel>(response.Content);
                    ...
                    if (response.IsSuccessful)
                    {
                        ...
                        {
                            response_code = responbody.response_code,
                            
                            collateral_id = responbody.collateral_id,
                            response_message = responbody.response_message,
                            bo_code = responbody.bo_code,
                            bo_message = responbody.bo_message
                        };
                        ...
                        var specificRes = new ResponseMessageViewModel
                        {
                             ...
                             //APIMessage = responbody,
                             webRequestDate = requestDatetime,
                             webRequestStatus = responbody.response_code,
                        };
                        ...
                        responseMsg = new ResponseMessage
                        {
                            ...
                            //Message = response
                            Msg = responbody.response_message
                        };
                    }
                    else
                    {
                ...
                finally
                {
                    ...
                    var loanMapping = new TBL_THIRDPARTY_LOAN_MAPPING
                    {
                        ...
                        FACILITYMAPPINGID = responbody.collateral_id,
                        BOOKINGCODE = responbody.bo_code,
                    };
                    ...
                    var logs = new TBL_CUSTOM_API_LOGS
                    {
                        ...
                        RESPONSEDATETIME = responseDateTime,
                        RESPONSEMESSAGE = responseMsg.ToString(),
                    };
