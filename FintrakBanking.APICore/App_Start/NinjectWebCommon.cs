...
namespace FintrakBanking.APICore.App_Start
{
    ...
    using FintrakBanking.Repositories.Setups.International;
    using FinTrakBanking.ThirdPartyIntegration.SubToHeadOffice;
    ...
    public static class NinjectWebCommon
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<IInternationalCustomerRepository>().To<InternationalCustomerRepository>();
            kernel.Bind<ISubToHeadOfficeIntegration>().To<SubToHeadOfficeIntegration>();
