...
{
    public partial class RiskAssetMain : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    ReportViewer.ServerReport.ReportPath = reportPath + "Risk Asset Main"; // string.Format(reportPath, "Risk Asset");
