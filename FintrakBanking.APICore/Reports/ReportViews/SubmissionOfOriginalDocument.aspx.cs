...
{
    public partial class SubmissionOfOriginalDocument : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                var data = reportObjects.GetOriginalDocumentSubmissionReport(startDate, endDate, referenceNumber);
                ...
                this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/OriginalDocumentSubmission.rdlc");
                this.ReportViewer.LocalReport.Refresh();
            }
        }
