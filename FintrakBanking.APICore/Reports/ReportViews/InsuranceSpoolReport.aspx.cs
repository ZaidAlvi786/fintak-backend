...
{
    public partial class InsuranceSpoolReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                int documentTypeId = int.Parse(Request.QueryString["documentTypeId"]);
                ...
                var data = reportObjects.InsuranceSpoolReport(startDate, endDate, documentTypeId);
                ...
                reportDataSource.Name = "InsuranceSpoolReport";

                this.ReportViewer.LocalReport.DataSources.Add(reportDataSource);
                this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/InsuranceSpoolReport.rdlc");
                this.ReportViewer.LocalReport.Refresh();
            }
        }
    }
...
<!-- Auto-push timestamp: 2026-01-09 10:11:44 -->