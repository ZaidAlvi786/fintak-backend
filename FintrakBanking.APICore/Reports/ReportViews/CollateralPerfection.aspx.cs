...
{
    public partial class CollateralPerfection : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    LoanReportObjects CollateralPerfection = new LoanReportObjects();
                    var data = CollateralPerfection.CollateralPerfection(startDate, endDate, status, companyId);

                    this.ReportViewer.LocalReport.DataSources.Clear();
                    ReportDataSource reportDataSource = new ReportDataSource();
                    reportDataSource.Value = data;
                    reportDataSource.Name = "CollateralPerfection";
                    ...
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/CollateralPerfection.rdlc");
...
<!-- Auto-push timestamp: 2026-02-08 18:19:27 -->