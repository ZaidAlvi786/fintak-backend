...
{
    public partial class CollateralRegister : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    var data = CollateralRegister.CollateralRegister(startDate, endDate, companyId, branchId);
                    ...
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/CollateralRegister.rdlc");
...
<!-- Auto-push timestamp: 2025-12-15 14:14:42 -->