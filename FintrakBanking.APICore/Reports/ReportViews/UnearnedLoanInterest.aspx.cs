...
{
    public partial class UnearnedLoanInterest : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    LoanReportObjects unearnedinterest = new LoanReportObjects();
                    var data = unearnedinterest.UnearnedLoanInterest(startDate, endDate, companyId);

                    this.ReportViewer.LocalReport.DataSources.Clear();
                    ReportDataSource reportDataSource = new ReportDataSource();
                    reportDataSource.Value = data;
                    reportDataSource.Name = "UnearnedLoanInterest";
                    ...
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/UnearnedLoanInterest.rdlc");
