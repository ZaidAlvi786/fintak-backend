...
{
    public partial class StaffRoleProfileActivityReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    StaffModifiedInformationReport staffRoleProfileActivityReport = new StaffModifiedInformationReport();
                    var data = staffRoleProfileActivityReport.StaffRoleProfileActivityReport(startDate, endDate, companyId);

                    this.ReportViewer.LocalReport.DataSources.Clear();
                    ReportDataSource reportDataSource = new ReportDataSource();
                    reportDataSource.Value = data;
                    reportDataSource.Name = "StaffRoleProfileActivityReport";
                    ...
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/StaffRoleProfileActivityReport.rdlc");
