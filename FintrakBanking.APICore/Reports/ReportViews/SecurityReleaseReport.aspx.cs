...
{
    public partial class SecurityReleaseReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                    ...
                    string referenceNumber = Request.QueryString["status"];
                    ...
                    LoanReportObjects SecurityReleaseReport = new LoanReportObjects();
                    var data = SecurityReleaseReport.SecurityReleaseReport(startDate, endDate);
                    ...
                    reportDataSource.Name = "SecurityReleaseReport";

                    this.ReportViewer.LocalReport.DataSources.Add(reportDataSource);
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/SecurityReleaseReport.rdlc");
                    this.ReportViewer.LocalReport.Refresh();
                }
        }
        }
