...
{
    public partial class LoanBookingReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    var data = loanReportObjects.GetLoanBookingReport(companyId, searchInfo, startDate, endDate);
                    ...
                    reportDataSource.Name = "LoanBooking";

                    this.ReportViewer.LocalReport.DataSources.Add(reportDataSource);
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/LoanBookingReport.rdlc");
                    this.ReportViewer.LocalReport.Refresh();
                }
                catch (Exception ex)
                {
