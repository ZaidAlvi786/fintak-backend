...
{
    public partial class RunningFacilitiesReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    LoanReportObjects runningFacilities = new LoanReportObjects();
                    var data = runningFacilities.RunningFacilities(startDate, endDate, companyId, staffId, crmSCode);

                    this.ReportViewer.LocalReport.DataSources.Clear();
                    ReportDataSource reportDataSource = new ReportDataSource();
                    reportDataSource.Value = data;
                    reportDataSource.Name = "RunningFacilities";
