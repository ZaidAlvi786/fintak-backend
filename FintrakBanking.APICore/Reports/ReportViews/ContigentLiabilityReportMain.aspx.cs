...
{
    public partial class ContigentLiabilityReportMain : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack) 
            {
                try
                {
                    ...
                    ReportViewer.ServerReport.ReportPath = reportPath + "Contigent Liability Main Report"; // string.Format(reportPath, "Risk Asset");
