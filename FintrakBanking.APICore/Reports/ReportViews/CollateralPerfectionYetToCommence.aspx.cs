...
{
    public partial class CollateralPerfectionYetToCommence : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    LoanReportObjects CollateralYetToCommence = new LoanReportObjects();
                    var data = CollateralYetToCommence.CollateralPerfectionYetToCommence(startDate, endDate, companyId);

                    this.ReportViewer.LocalReport.DataSources.Clear();
                    ReportDataSource reportDataSource = new ReportDataSource();
                    reportDataSource.Value = data;
                    reportDataSource.Name = "CollateralPerfectionYetToCommenceDataset";
                    ...
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/CollateralPerfectionYetToCommence.rdlc");
