...
{
    public partial class InsiderRelatedLoansReport : System.Web.UI.Page
    {
            ...
            if (!IsPostBack)
            {
                try
                {
                   ...
                   // int companyId = Int32.Parse(Request.QueryString["companyId"]);
                    ...
                    var data = Jobs.GetInsiderRelatedLoans(startDate,endDate,null );

                    this.ReportViewer.LocalReport.DataSources.Clear();
                    ReportDataSource reportDataSource = new ReportDataSource();
                    reportDataSource.Value = data;
                    reportDataSource.Name = "InsiderRelatedLoans";
                    ...
                    this.ReportViewer.LocalReport.ReportPath = Server.MapPath("~/Reports/Report/InsiderRelatedLoanReport.rdlc");
...
<!-- Auto-push timestamp: 2026-03-12 16:45:39 -->