...
namespace FintrakBanking.APICore.Controllers
{
    ...
    public class ProductController : ApiControllerBase
    {
      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public async Task<HttpResponseMessage> GetAllProductBehaviour(int productId)
        {
            try
            {
                var data = await repo.GetProductBehaviour(productId);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetProductPriceIndexByProductId(int productId)
        {
            try
            {
                var data = await repo.GetProductPriceIndexByProductId(productId);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async  Task<HttpResponseMessage> GetProductCurrency(int id)
        {
            try
            {
                var data = await repo.GetProductCurrency(id);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("No Record Found") });
      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public async Task<HttpResponseMessage> GetProductClassByProcessId(int id)
        {
            try
            {
                var data = await repo.GetProductClassByProcessId(id);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("No Record Found") });
      ...
      [HttpGet] [ClaimsAuthorization]  
       ...
       [HttpPut] [ClaimsAuthorization]
        ...
        public async Task<HttpResponseMessage> GetAllProduct(int id, int cid)
        {
            
                var data = await repo.GetAllProductByProductClass(id, cid);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        {
                var data = repo.GetAllProductByProductClassAndCustomerType(productclassId, customerTypeId);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetAllProductsByProductClassIdAndCustomerTypeId(int productclassId, int customerTypeId)
        {
           

                var data = await repo.GetAllProductsByProductClassIdAndCustomerTypeId(productclassId, customerTypeId);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        [HttpGet] [ClaimsAuthorization]  
        [Route("product-lite")]
        public async Task<HttpResponseMessage> GetAllProductLite()
        {
            try
            {
                var data = await repo.GetAllProductLite();
                return Request.CreateResponse(HttpStatusCode.OK,new { success = true, result = data });  //Ok(accounts);
            }
            catch (SecureException ex)
            {
      ...
      [HttpGet] [ClaimsAuthorization]  
       ...
       [HttpPut] [ClaimsAuthorization]
        ...
        [ClaimsAuthorization]
        [Route("crms-type")]
        public async Task<HttpResponseMessage> GetAllCRMSType()
        {
            try
            {
                var data = await repo.GetAllCRMSType(token.GetCompanyId);
        ...
        public async Task<HttpResponseMessage> GetAllRiskRatingType()
        {
            try
            {
                var data = await repo.GetAllRiskRatingType(token.GetCompanyId);
       ...
       [HttpPut] [ClaimsAuthorization]
        ...
        public async  Task<HttpResponseMessage> GetAllProductClassProcess()
        {
            try
            {
                var data = await repo.GetAllProductClassProcesses();
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("No Record Found") });
      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public async Task<HttpResponseMessage> GetAllProductClassification()
        {
            try
            {
                var data = await repo.GetAllProductClassification();
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public HttpResponseMessage AddProductDocumentDefinition([FromBody] DocumentDefinitionViewModel model)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, result = data, message = TranslateHelper.get("product document definition has been created successfully") });
                }
                else
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("product document definition not created") });
            }
            catch (SecureException ex)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
        ...
        public async Task<HttpResponseMessage> GetAllProductDocumentMapping()
        {
            try
            {
                var data =  await repo.GetAllProductDocumentMapping();
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public HttpResponseMessage AddProductDocumentMapping([FromBody] ProductDocumentMappingViewModel model)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, result = data, message = TranslateHelper.get("product document mapping has been created successfully") });
                }
                else
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = TranslateHelper.get("product document mapping not created") });
            }
            catch (SecureException ex)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
        ...
        public HttpResponseMessage UpdateProductDocumentMapping ([FromBody] ProductDocumentMappingViewModel model, int id)
        {
            ...
            return Request.CreateResponse(HttpStatusCode.OK, new { success = response, result = response, count = 1, message = TranslateHelper.get("product document mapping has been edited successfully") });
        }

        [HttpGet]
        [ClaimsAuthorization]
        [Route("product-document-mapping/{id}")]
        public async Task<HttpResponseMessage> GetProductDocumentCategory(int id)
        {
            ProductDocumentMappingViewModel response = await repo.GetProductDocumenetMapping(id);
