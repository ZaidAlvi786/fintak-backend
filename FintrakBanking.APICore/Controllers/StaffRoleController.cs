      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public HttpResponseMessage AddUpdateStaffRole([FromBody] StaffRoleViewModel entity)
        {
            try
            {
                ...
                if (entity.staffRoleId != 0 || entity.staffRoleId > 0)
                {
                    ...
                    if (repo.ValidateStaffRoleUpdate(entity.staffRoleId))
                    {
                        return Request.CreateResponse(HttpStatusCode.OK,
                                               new { success = false, message = TranslateHelper.get("This Staff Role is undergoing approval")
                                               + Environment.NewLine + TranslateHelper.get("Approve previous entry to continue")});
                    }
                }
                else
                {
                    ...
                    {
                        return Request.CreateResponse(HttpStatusCode.OK,
                                               new { success = false, message = TranslateHelper.get("Staff Role with same Name or Code already exist") });
                    }
                }
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, result = data, message = TranslateHelper.get("Action successful and sent for approval") });
                }
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("There was an error performaing action") });
            }
        ...
        public HttpResponseMessage GoForApproval([FromBody]ApprovalViewModel entity)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, message = TranslateHelper.get("Staff Role has been approved successfully") });
                }
        ...
        public HttpResponseMessage AddApprovalSetUp([FromBody] ApprovalSetUpViewModel entity)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, message = TranslateHelper.get("SetUp has been added successfully") });
                }
        ...
        public HttpResponseMessage UpdateApprovalSetUp([FromBody] ApprovalSetUpViewModel entity)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, message = TranslateHelper.get("SetUp has been updated successfully") });
                }

                return Request.CreateResponse(HttpStatusCode.OK,
                    new { success = true, message = TranslateHelper.get("Operation successful") });
            }
            catch (SecureException ex)
            {
        ...
        public HttpResponseMessage AddFlowOrder([FromBody] OperationPageOrderViewModel entity)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, message = TranslateHelper.get("FlowOrder has been added successfully") });
                }
        ...
        [HttpGet]
        [ClaimsAuthorization]
        [Route("all-approval-flow-type")]
        public HttpResponseMessage GetAllApprovalFlowType()
        {
            try
            {
                var data = repo.GetAllApprovalFlowType();
