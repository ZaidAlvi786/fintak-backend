    ...
    public class LoanCovenantController : ApiControllerBase
    {
        ...
        public HttpResponseMessage AddLoanCovenantDetail([FromBody] LoanCovenantDetailViewModel entity)
        {
                ...
                var data = repo.AddLoanCovenantDetail(entity);
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = entity, message = TranslateHelper.get("The record has been created successfully") });
        ...
        public async Task<HttpResponseMessage> DeleteLoanCovenantDetail(int loanCovenantDetailId)
        {
            ...
            try
            {
                ...
                if (data)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = data, message = TranslateHelper.get("Deleted successfully") });
                }
       ...
       [HttpPut] [ClaimsAuthorization][Route("covenant-detail/{id}")]
        public async Task<HttpResponseMessage> UpdateLoanCovenantDetail([FromBody] LoanCovenantDetailViewModel entity, int id)
        {
            try
            {
                ...
                if (data)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = entity, message = TranslateHelper.get("The record has been Update successfully") });
                }

                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error Update this record") });
            }
            catch (SecureException ex)
            {
                //this.errorLogger.LogError(ex, this.Request.Path.Value, token.GetUsername);
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error Update this record") +" "+ TranslateHelper.get(ex.Message)} );
            }
        }
      ...
      [HttpGet] [ClaimsAuthorization]  [Route("covenant-type")]
       ...
       [HttpPut] [ClaimsAuthorization][Route("covenant-type/{id}")]
        ...
        public async Task<HttpResponseMessage> GetLoanApplicationCovenant(int id)
        {
            
                var data = await repo.GetLoanApplicationCovenant(id);
                if (data != null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = data });
                }
                else { 
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message =  TranslateHelper.get("No records found") });
                }
        }
        ...
        public async Task<HttpResponseMessage> AddLoanApplicationCovenant([FromBody] LoanCovenantDetailViewModel entity)
        {
            try
            {
                entity.userBranchId = (short)token.GetBranchId;
                ...
                entity.createdBy = token.GetStaffId;
                entity.applicationUrl = HttpContext.Current.Request.Path;
                var data =await repo.AddLoanApplicationCovenant(entity);
                if (data)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = entity, message = TranslateHelper.get("The record has been created successfully") });
                }
        ...
        public async Task<HttpResponseMessage> DeleteLoanApplicationCovenant(int id)
        {
            try
            {
                UserInfo user = new UserInfo()
                ...
                var data =await repo.DeleteLoanApplicationCovenant(id, user);
                if (data)
                {
        ...
        public async Task<HttpResponseMessage> GetLoanApplicationCovenantLms(int id)
        {
            try
            {
                IEnumerable<LoanCovenantDetailViewModel> data =await repo.GetLoanApplicationCovenantLms(id);
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = data });
            }
            catch (SecureException ex)
            {
        ...
        public async Task<HttpResponseMessage> AddLoanApplicationCovenantLms([FromBody] LoanCovenantDetailViewModel entity)
        {
                entity.userBranchId = (short)token.GetBranchId;
                entity.companyId = token.GetCompanyId;
                entity.createdBy = token.GetStaffId;
                entity.applicationUrl = HttpContext.Current.Request.Path;
                bool data =await repo.AddLoanApplicationCovenantLms(entity);
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = entity, message = TranslateHelper.get("The record has been created successfully") });
        }

        [HttpPut]
        [ClaimsAuthorization]
        [Route("lms-loan-application-covenant/{covenantId}")]
        public async Task<HttpResponseMessage> UpdateLoanApplicationCovenantLms(int covenantId, [FromBody] LoanCovenantDetailViewModel entity)
        {
            entity.userBranchId = (short)token.GetBranchId;
            entity.companyId = token.GetCompanyId;
            entity.createdBy = token.GetStaffId;
            entity.applicationUrl = HttpContext.Current.Request.Path;
            bool data = await repo.UpdateLoanApplicationCovenantLms(covenantId, entity);
            return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = entity, message = TranslateHelper.get("The record has been updated successfully") });
        }
        ...
        public async Task<HttpResponseMessage> DeleteLoanApplicationCovenantLms(int id)
        {
            try
            {
                UserInfo user = new UserInfo()
                ...
                bool data =await repo.DeleteLoanApplicationCovenantLms(id, user);
                if (data)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = data, message = "Deleted successfully" });
                }
