    ...
    public class MonitoringSetupController : ApiControllerBase
    {
        ...
        public HttpResponseMessage AddMonitoringSetup( [FromBody]MonitoringSetupViewModel entity)
        {
            ...
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = MonitoringSetup, message = TranslateHelper.get("The record has been created successfully") });
            }
      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public HttpResponseMessage GetAllMonitoringSetup()
        {
            ...
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("No MonitoringSetup found") });
            }
