      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public HttpResponseMessage UploadJsonFile()
        {
            ...
            try
            {
                ...
                if (result)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, message = TranslateHelper.get("Document upload was successful") });
                }
            }
            ...
            return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("The was an error while uploading document") });
        }
        ...
        public async Task<HttpResponseMessage> Upload()
        {
            ...
            return Request.CreateResponse(HttpStatusCode.OK, TranslateHelper.get("Successfully Uploaded"));
        }
...
public class MultipartFormDataMemoryStreamProvider : MultipartMemoryStreamProvider
{
    ...
    public override Stream GetStream(HttpContent parent, HttpContentHeaders headers)
    {
        ...
        {
            throw new InvalidOperationException(TranslateHelper.get("Did not find required 'Content-Disposition' header field in MIME multipart body part"));
        }
