    ...
    public class OfferLetterAndAvailmentController : ApiControllerBase
    {
        ...
        public async Task<HttpResponseMessage> GetCamProcessedLoanApplicationsDueForOfferLetter()
        {
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = response, count = response.Count(), message = TranslateHelper.get("No Record Found") });
            }
            catch (SecureException e)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, error = $"{TranslateHelper.get("Error")}: {TranslateHelper.get(e.Message)}" });
            }
        }
        ...
        public async Task<HttpResponseMessage> AddCRMSCollateralType([FromBody] ApprovedLoanDetailViewModel model)
        {
            try
            {
                ...
                var data = await repo.AddCRMSCollateralType(applicationId, model);
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                    new { success = false, message = $"{TranslateHelper.get("There was an error updating this record")} {TranslateHelper.get(e.Message)}" });
            }
        ...
        public async Task<HttpResponseMessage> GetCamProcessedLoanApplicationsDueForReview()
        {
            try
            {
                ...
                if (!response.Any())
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = false, result = response, message = TranslateHelper.get("No Record Found") });
                }
        ...
        public HttpResponseMessage GetCamProcessedLoanApplicationsDueForAvailment()
        {
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, error = $"{TranslateHelper.get("Error")}: {e.Message}" });
            }
        }
        ...
        public HttpResponseMessage UpdateFinalOfferLetter([FromUri] int loanApplicationId, [FromBody] OfferLetterTemplateViewModel model)
        {
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error updating this group") });
            }
            catch (SecureException e)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error updating this group") });
        ...
        public async Task<HttpResponseMessage> GenerateForm3800Template([FromUri] string applicationRefNumber)
        {
            try
            {
                var response = await repo.GenerateForm3800Template(applicationRefNumber);
        ...
        public async Task<HttpResponseMessage> GenerateForm3800TemplateLMS([FromUri] string applicationRefNumber)
        {
            try
            {
                var response = await repo.GenerateForm3800TemplateLMS(applicationRefNumber);
        ...
        public async Task<HttpResponseMessage> SaveDraftOfferLetter([FromBody] OfferLetterTemplateViewModel model)
        {
            try
            {
                var response = await repo.SaveDraftOfferLetter(model);
        ...
        public async Task<HttpResponseMessage> UpdateDraftOfferLetter(int documentId, [FromBody] OfferLetterTemplateViewModel model)
        {
            try
            {
                model.userBranchId = (short)token.GetBranchId;
                ...
                var response = await repo.UpdateDraftOfferLetter(documentId, model);
        ...
        public async Task<HttpResponseMessage> ApproveLoanAvailmentDecision([FromBody] LoanAvailmentApprovalViewModel entity)
        {
            ...
            var data = await repo.ApproveLoanAvailmentDecision(entity);
        ...
        public async Task<HttpResponseMessage> SendBackToBusinessAvailment([FromBody] LoanAvailmentApprovalViewModel entity)
        {
            entity.BranchId = token.GetBranchId;
            entity.companyId = token.GetCompanyId;
            entity.staffId = token.GetStaffId;
            ...
            bool data = await repo.SendBackToBusinessAvailment(entity);
        ...
        public async Task<HttpResponseMessage> ReferBackOneStep([FromBody] LoanAvailmentApprovalViewModel entity)
        {
            entity.BranchId = token.GetBranchId;
            entity.companyId = token.GetCompanyId;
            entity.staffId = token.GetStaffId;
            ...
            bool data = await repo.ReferBackOneStep(entity);
        ...
        public async Task<HttpResponseMessage> LogApplicationForApprovalDuringOfferLetterGeneration([FromBody] LoanAvailmentApprovalViewModel entity)
        {
            entity.BranchId = token.GetBranchId;
            entity.companyId = token.GetCompanyId;
            entity.staffId = token.GetStaffId;
            ...
            var response = await repo.ApproveOfferLetterGeneration(entity);
        ...
        public async Task<HttpResponseMessage> OfferLetterRejection([FromBody] ForwardViewModel entity)
        {
            try
            {
                entity.userBranchId = (short)token.GetBranchId;
                ...
                bool response = await repo.OfferLetterRejection(entity);
        ...
        public async Task<HttpResponseMessage> GetCommentOnLoanAvailment([FromUri] string applicationRefNumber)
        {
            try
            {
                var response = await repo.GetCommentOnLoanAvailment(applicationRefNumber);
        ...
        public async Task<HttpResponseMessage> EditOfferLetterClause(OfferLetterViewModel data)
        {
            try
            {
                bool response = await repo.EditOfferLetterClause(data.loanApplicationId, data.offerLetterClauses,data.isLMS, token.GetStaffId, token.GetBranchId);
        ...
        public async Task<HttpResponseMessage> EditOfferLetterAcceptance(OfferLetterViewModel data)
        {
            try
            {
                bool response = await repo.EditOfferLetterAcceptance(data.loanApplicationId, data.offerLetteracceptance,data.isLMS, token.GetStaffId, token.GetBranchId);
        ...
        public async Task<HttpResponseMessage> EditOfferLetterTtitle(OfferLetterViewModel data)
        {
            try
            {
                bool response = await repo.EditOfferLetterTitle(data.customerId, data.offerLetterTitle, token.GetStaffId, token.GetBranchId);
        ...
        public async Task<HttpResponseMessage> EditOfferLetterSalutation(OfferLetterViewModel data)
        {
            try
            {
                bool response = await repo.EditOfferLetterSalutation(data.customerId, data.offerLetterSalutation, token.GetStaffId, token.GetBranchId);
        ...
        public async Task<HttpResponseMessage> GetOfferLetterTitle(int customerId)
        {
            try
            {
                var response = await repo.GetOfferLetterTitle(customerId);
        ...
        public async Task<HttpResponseMessage> GetOfferLetterClauses(int loanApplicationId)
        {
            try
            {
                var response = await repo.GetOfferLetterClause(loanApplicationId);
        ...
        public async Task<HttpResponseMessage> GetOfferLetterAcceptance(int loanApplicationId)
        {
            try
            {
                var response = await repo.GetOfferLetterAcceptance(loanApplicationId);
        ...
        public HttpResponseMessage IsOfferLEtterGenerated(OfferLetterViewModel data)
        {
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = response, message = TranslateHelper.get("success") });
        ...
        public async Task<HttpResponseMessage> ApplyTemplateToOfferLetter(OfferLetterViewModel data)
        {
            try
            {
                bool response = await repo.ApplyTemplateToOfferLetter(data.documentTemplate, data.loanApplicationId, token.GetStaffId, token.GetBranchId);

                //bool response = repo.EditOfferLetterTitle(data.customerId, data.offerLetterTitle, token.GetStaffId, token.GetBranchId);

                if (response == true)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = response, message = TranslateHelper.get("The Template was Attached successfully") });
                }
