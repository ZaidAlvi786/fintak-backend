...
namespace FintrakBanking.APICore.Controllers
{
    ...
    public class AccountController : ApiControllerBase
    {
        ...
        public IHttpActionResult Logout()
        {
            ...
            context.SaveChanges();
            var message = TranslateHelper.get("User Logged Off");
            var successObject = new { success = true,  message =  message  };
        ...
        public async Task<IHttpActionResult> AddExternalLogin(AddExternalLoginBindingModel model)
        {
            ...
            {
                var message = TranslateHelper.get("External login failure");
            ...
            {
                var message = TranslateHelper.get("The external login is already associated with an account");
                return BadRequest(message);
            }
