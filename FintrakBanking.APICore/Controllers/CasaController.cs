...
namespace FintrakBanking.APICore.Controllers
{
    ...
    public class CasaController : ApiControllerBase
    {
        ...
        public async Task<HttpResponseMessage> GetAccount(int accountId)
        {
            try
            {
                CasaViewModel data = await repo.GetAccount(accountId);
        ...
        public HttpResponseMessage GetCASABalance(string accountNumber)
        {
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("Error: An unexpected exception  occured") });
            }
        }
            ...
            try
            {
                ...
                else
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = true, message = TranslateHelper.get("No Record Found") });
                }
            }
            catch (SecureException ex)
            {
        ...
        public async Task<HttpResponseMessage> GetAllCustomerAccountByCustomerIdAndCurrency(int id, int currencyId)
        {
            try
            {
                var data = await repo.GetAllCustomerAccountByCustomerIdAndCurrency(id, token.GetCompanyId, currencyId);
                if (data != null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = data });
                }
        ...
        public async Task<HttpResponseMessage> GetAllCustomerAccountByCustomerId(int id)
        {
            try
            {
                var data = await repo.GetAllCustomerAccountByCustomerId(id, token.GetCompanyId);
                if (data != null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = data });
                }
        ...
        public async Task<HttpResponseMessage> GetAllCasaLoans(int casaAccountId)
        {
            try
            {
                var data = await repo.GetAllCasaLoans(token.GetCompanyId, casaAccountId);
                if (data.Count() < 1)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = false, message = TranslateHelper.get("There's no Loan Attached to this Account Number") });
                }
                return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = true, result = data });
            }
        ...
        public HttpResponseMessage AddConsumerProtection([FromBody] ConsumerProtectionViewModel model)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, result = result, message = TranslateHelper.get("Consumer Protection has been created successfully") });
                }
                return Request.CreateResponse(HttpStatusCode.OK,
                    new { success = false, message = TranslateHelper.get("Consumer Protection could not be created") });
            }
            catch (SecureException ex)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get(ex.Message) });
        ...
        public async Task<HttpResponseMessage> GetDocumentSection(int operationId, int targetId, int sectionId)
        {
            try
            {
                LoadedDocumentSectionViewModel response = await lienRepo.GetDocumentSectionConsumerProtection(token.GetStaffId, operationId, targetId, sectionId);
        ...
        public async Task<HttpResponseMessage> GetLoadedDocumentationConsumerProtection(int consumerProtectionById, int operationId)
        {
            try
            {
                ...
                List<LoadedDocumentSectionViewModel> response = await lienRepo.GetLoadedDocumentationConsumerProtection(token.GetStaffId, operationId, consumerProtectionById, user);
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, message = "", result = response });
            }
            catch (SecureException ex)
            {
        ...
        public HttpResponseMessage AddCasaLien([FromBody] CasaLienViewModel model)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, result = result, message = TranslateHelper.get("Casa Lien has been created successfully") });
                }
                return Request.CreateResponse(HttpStatusCode.OK,
                    new { success = false, message = TranslateHelper.get("Casa Lien could not be created") });
            }
            catch (SecureException ex)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get(ex.Message) });
        ...
        public HttpResponseMessage RemoveCasaLien([FromBody] CasaLienViewModel model)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, result = result, message = TranslateHelper.get("Casa Lien has been removed successfully") });
                }
                return Request.CreateResponse(HttpStatusCode.OK,
                    new { success = false, message = TranslateHelper.get("Casa Lien could not be removed") });
            }
            catch (SecureException ex)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get(ex.Message) });
       ...
       [HttpGet]
        ...
        public async Task<HttpResponseMessage> SearchCustomerAccountDetails(int customerId)
        {
            try
            {
                var data = await repo.GetCustomerAccountDetailsById(customerId);
