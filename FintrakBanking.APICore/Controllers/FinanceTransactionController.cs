      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public HttpResponseMessage GetCustomerAccountTypeFromFinnacle(string accountNumber)
        {
            try
            {
                ...
                if (data != null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = data, message = TranslateHelper.get("Record found successfully") });
                }
        ...
        public HttpResponseMessage PostTransaction( [FromBody] List<FinanceTransactionViewModel> transaction)
        {
            try
            {
                ...
                if (data != null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = data, message = TranslateHelper.get("Transaction Posted successfully") });
                }
        ...
        public HttpResponseMessage getGLandAccountName()
        {
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error fetchcing the records. Error") });
            }
        }
