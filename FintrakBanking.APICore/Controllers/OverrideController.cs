    ...
    public class OverrideController : ApiControllerBase
    {
        ...
        public HttpResponseMessage AddOverRideRequest([FromBody] IEnumerable<OverrideDetailVeiwModel> entity)
        {
            ...
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = response, count = 1, message = TranslateHelper.get("Override Request was successful and undergoing approval") });
        ...
        {            
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, message = TranslateHelper.get("Override Approved successfully"), result = response });
            }
       ...
       [HttpPut] [ClaimsAuthorization]
        ...
        public HttpResponseMessage UpdateOverRideRequest(OverrideDetailVeiwModel entity)
        {
            ...
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, message = TranslateHelper.get("update was successful"), result = response });
            }
            catch (SecureException e)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = $"{TranslateHelper.get("Error")}: {TranslateHelper.get(e.Message)}" });
            }
        }
    }
}

<!-- Auto-push timestamp: 2026-01-07 20:12:05 -->