...
namespace FintrakBanking.APICore.Controllers
{
    ...
    public class LoanOperationsController : ApiControllerBase
    {
        ...
        public async Task<HttpResponseMessage> AddBulkPrepaymentReversal([FromBody] LoanReviewOperationViewModel model)
        {
            //try
            //{
            ...
            try
            {
                var response = await repo.AddBulkPrepaymentReversal(model, model.companyId);
        ...
        public async Task<HttpResponseMessage> GetOperationType(bool isFinalOperation)
        {
            
                var data = await repo.GetOperationType(isFinalOperation);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("No Record Found") });
                }
        ...
        public async Task<HttpResponseMessage> GetOperationTypeByOD()
        {
            
                var data = await repo.GetOperationTypeByOD();
                if (data == null)
                {
        ...
        public async Task<HttpResponseMessage> GetRemedialOperationType()
        {
            
                var data = await repo.GetRemedialOperationType();
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLoanReviewApplicationOverDraft()
        {
           
                var data = await loanRepo.GetLoanReviewApplicationOverDraft(token.GetStaffId, token.GetCompanyId);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> SearchForOverdraft(int revolvingLoanId)
        {
            
                var data = await loanRepo.GetOverdraftDetailsByLoanId(revolvingLoanId);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> ApproveFacilityModification([FromBody] ForwardViewModel model)
        {
            model.userBranchId = (short)token.GetBranchId;
            ...
            try
            {
                WorkflowResponse response =await loanRepo.ApproveLMSFacilityModification(model);
                if (response != null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = response, message = response.responseMessage });
                }
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error approving this record") });
            }
            catch (SecureException ex)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get(ex.Message) });
        ...
        [ClaimsAuthorization]
        [Route("lms-facility-modification/approval")]
        public async Task<HttpResponseMessage> GetFacilityModificationsForApproval()
        {
            try
            {
                IEnumerable<FacilityModificationViewModel> response =await loanRepo.GetLMSFacilityModificationsForApproval(token.GetStaffId);
        ...
        public async Task<HttpResponseMessage> ModifyLMSFacility([FromBody] FacilityModificationViewModel model)
        {
            model.createdBy = token.GetStaffId;
            model.companyId = token.GetCompanyId;
            var response = await loanRepo.AddFacilityModification(model);
            if (response != null)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = response, message = response.responseMessage });
            }
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, result = response, message = TranslateHelper.get("Error saving record") });
            }
        }
        ...
        public HttpResponseMessage AddPrepaymentReversal([FromBody] LoanReviewOperationViewModel model)
        {
            ...
            if (response)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = response, message = TranslateHelper.get("Record created successfully, now waiting for approval") });
            }
            return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error creating this record") });
        ...
        public async System.Threading.Tasks.Task<HttpResponseMessage> AddRequestUnLienODAccount()
        {
            ...
            try
            {
                ...
                var response = await repo.AddRequestUnLienODAccount(entity, buffer);


                if (response == 2) return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = response, message = TranslateHelper.get("The record has been created successfully and waiting for approval") });
            ...
            catch (Exception ex) { return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error creating request") }); }
            return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error creating request") });
        ...
        public async Task<HttpResponseMessage> GetApprovedLoanReviewRemedial()
        {
                var userId = token.GetStaffId;

                var data = await loanRepo.GetApprovedLoanReviewRemedial(userId, token.GetCompanyId);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> CancelFullAndFinal(int loanId)
        {
                var data =await loanRepo.CancelFullAndFinal(loanId);
                if (data == false)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> CancelFullAndFinal(int loanId, int statusId)
        {
            bool response = false;
                if (statusId == (int)FullAndFinalStatusEnum.Cancelled)
                {
                     response =await loanRepo.CancelFullAndFinal(loanId, statusId);
                }
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                 new { success = true, message = TranslateHelper.get("Operation successfully") });
            }
        ...
        public async Task<HttpResponseMessage> getDisbursedCommercialLoanTrancheDetailsById(int loanId)
        {
           
                var data =await  loanRepo.getDisbursedCommercialLoanTrancheDetailsById(loanId);
                if (data.Count < 1)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLoanConvenant(int loanId)
        {
           
                var data =  await loanRepo.GetLoanCovenant(loanId);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLoanChargeFee(int loanId)
        {
            
                var data = await loanRepo.GetLoanChargeFee(loanId);
                if (data == null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        [HttpGet]
        [ClaimsAuthorization]
        [Route("loan-chargefeeODF/")]
        public HttpResponseMessage GetLoanChargeFeeODF(int loanId)
        {

            var data = loanRepo.GetLoanChargeFeeODF(loanId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLoanOperationAwaitingApproval(){
            var data = await repo.GetLoanOperationAwaitingApproval(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLoanOperationByLoanReferenceAwaitingApproval(string loanReference)
        {
            var data = await repo.GetLoanOperationByLoanReferenceAwaitingApproval(token.GetStaffId, token.GetCompanyId, loanReference);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLienSearchData(string searchString)
        {
            var data = await repo.GetLienSearchData(searchString);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLienRemovalAwaitingApprovalList(string source)
        {
            var data = await repo.GetBulkRecoveryToAgentAwaitingApprovalList(source, token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetBulkRetailRecoveryToAgentAwaitingApproval()
        {
            var data = await repo.GetBulkRetailRecoveryToAgentAwaitingApproval(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getBulkUnassignmentRetailRecoveryFromAgentAwaitingApproval()
        {
            var data = await repo.GetBulkUnassignmentRetailRecoveryFromAgentAwaitingApproval(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> BulkRecoveryToAgentAwaitingApprovalList(string source)
        {
            var data = await repo.BulkRecoveryToAgentAwaitingApprovalList(source, token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLienRemovalDocuments(int lienRemovalId)
        {
            var data = await repo.GetLienRemovalDocuments(lienRemovalId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLoanOperationAwaitingDocumentation()
        {
            var data = await repo.GetLoanOperationDocumentation(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLoanOperationAwaitingDocumentation(string searchString)
        {
            var data = await repo.GetLoanOperationDocumentationSearch(token.GetStaffId, token.GetCompanyId, searchString);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLMSCompletedLoanOperationAwaitingDocumentation([FromBody] CompletedCreditDocumentationModel obj)
        {
            var data = await repo.GetCompletedLoanOperationDocumentation(token.GetStaffId, token.GetCompanyId, obj.startDate, obj.endDate);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLoanOperationAwaitingDocumentationLos()
        {
            var data = await repo.GetLoanOperationDocumentationLos(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLoanOperationAwaitingDocumentationLosSearch(string searchString)
        {
            var data = await repo.GetLoanOperationDocumentationLosSearch(token.GetStaffId, token.GetCompanyId, searchString);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetAllCompletedLoanOperationDocumentationLos([FromBody] CompletedCreditDocumentationModel obj)
        {
            var data = await repo.GetAllCompletedLoanOperationDocumentationLos(token.GetStaffId, token.GetCompanyId, obj.startDate, obj.endDate);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLoanOperationDocumentationLosApproval()
        {
            var data = await repo.GetLoanOperationDocumentationLosApproval(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        [HttpGet]
        [ClaimsAuthorization]
        [Route("loan-operation/awaiting-documentation-lms-approval")]
        public async Task<HttpResponseMessage> GetLoanOperationDocumentationLmsApproval()
        {
            var data = await repo.GetLoanOperationDocumentationLmsApproval(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetBulkInsuranceUploadAwaitingApproval()
        {
            var data = await repo.GetBulkInsuranceUploadAwaitingApproval(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetAllLoansOperationWriteOffAnalysis()
        {
            var data = await repo.GetAllLoansOperationWriteOffAnalysis(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetLoanOperationRecoveryAnalysis()
        {
            var data = await repo.GetLoanOperationRecoveryAnalysis(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllLoansOperationRecoveryAnalysisByAgent(string source)
        {
            var data = await repo.getAllLoansOperationRecoveryAnalysisByAgent(source, token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllRecoveryComputationVariables()
        {
            var data = await repo.getAllRecoveryComputationVariables(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllUnassignedRecoveryOperationByAgent(string source)
        {
            var data = await repo.getAllUnassignedRecoveryOperationByAgent(source, token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllLoansForRecoveryAnalysisByAgent(string source)
        {
            var data = await repo.getAllLoansForRecoveryAnalysisByAgent(source, token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllLoansForRecoveryAnalysisBySingleAgent(string source)
        {
            var data = await repo.getAllLoansForRecoveryAnalysisBySingleAgent(source, token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllLoansForExternalRecoveryAnalysisByAgent(string source)
        {
            var data = await repo.getAllLoansForExternalRecoveryAnalysisByAgent(source, token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> generateRecoveryMailToAgents(string source)
        {
            bool data = await repo.generateRecoveryMailToAgents(source, token.GetStaffId, token.GetCompanyId);
            if (data)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = true, message = TranslateHelper.get("mail sent successfully") });
            }
            else
        ...
        public async Task<HttpResponseMessage> getAllPendingEmailAlert(string source)
        {
            var data = await repo.getAllPendingEmailAlert(source, token.GetStaffId, token.GetCompanyId);
            if (data != null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
        ...
        public async Task<HttpResponseMessage> getAllRecoveryCommissonByAgents()
        {
            var data = await repo.getAllRecoveryCommissonByAgents(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllInternalRecoveryCommissonByAgents()
        {
            var data = await repo.getAllInternalRecoveryCommissonByAgents(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllRecoveryReportCollectionByAgents()
        {
            var data = await repo.getAllRecoveryReportCollectionByAgents(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetAllLoansRecoveredByAgent()
        {
            var data = await repo.GetAllLoansRecoveredByAgents(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetAllLoansRecoveredByAgents()
        {
            var data = await repo.GetAllLoansRecoveredByAgentForReporting(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetAllBulkLoansRecoveredByAgent(int accreditedConsultantId, string referenceId)
        {
            var data = await repo.getAllLoansRecoveryAnalysisByAgent(token.GetStaffId, token.GetCompanyId, accreditedConsultantId, referenceId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetAllBulkUnassignLoansRecoveredByAgent(int accreditedConsultantId, int referenceId)
        {
            var data = await repo.getAllUnassignLoansRecoveryAnalysisByAgent(token.GetStaffId, token.GetCompanyId, accreditedConsultantId, referenceId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllLoansRecoveryAnalysisByAgentRemedial(int accreditedConsultantId, string referenceId)
        {
            var data = await repo.getAllLoansRecoveryAnalysisByAgentRemedial(token.GetStaffId, token.GetCompanyId, accreditedConsultantId, referenceId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetApprovalDetails(int loanId, int operationId)
        {
            
                var data = await repo.GetApprovalDetails(loanId, operationId);
        ...
        public async Task<HttpResponseMessage> GoForApproval([FromBody]ApprovalViewModel entity)
        {
            ...
            WorkflowResponse data = await repo.GoForApproval(entity);
            if (data.statusId == (int)ApprovalStatusEnum.Disapproved)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                    new { success = true, message = "Operation has been disapproved successfully." });
            }
            else if (data.stateId == (int)ApprovalState.Ended)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                new { success = true, message = TranslateHelper.get("Operation has been approved successfully. Sent to Credit Documentation for filling") });
            }
        ...
        public async Task<HttpResponseMessage> GoForLienRemovalApproval([FromBody]ApprovalViewModel entity)
        {
            entity.BranchId = token.GetBranchId;
            entity.companyId = token.GetCompanyId;
            entity.staffId = token.GetStaffId;
            ...
            var data = await repo.GoForLienRemovalApproval(entity);

            if (data == 1)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                    new { success = true, message = TranslateHelper.get("Operation has been approved successfully.") });
            }
            else if (data == 2)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                    new { success = true, message = TranslateHelper.get("Operation has been disapproved successfully.") });
            }
            else if (data == 3)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("Approval failed") });
            }
        }
        ...
        public async Task<HttpResponseMessage> SearchForContingent(int revolvingLoanId)
        {
            var data = await loanRepo.GetContingentByLoanId(revolvingLoanId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> AddOperationReviewContingentWithAttachment()
        {
...

            {
                ...
                //    return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = "The requested operation already exist and going through approval" });
                //}
                var response = await repo.SaveDocument(model, buffer);
                //var response = repo.AddOperationReviewContingentWithImage(model, buffer);
                if (response)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = response, message = TranslateHelper.get("The record has been created successfully and passed for approval") });
                }
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error creating this record") });
            }
            ...
            else if ((int)OperationsEnum.ContingentLiabilityTerminateAndRebook == model.operationTypeId)
            {
                ...
                var response = await repo.SaveDocument(model, buffer);//AddOperationReviewContingentWithImage(model, buffer);
                if (response)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = response, message = TranslateHelper.get("The record has been created successfully and passed for approval") });
                }
            ...
            else if ((int)OperationsEnum.CancelContingentLiability == model.operationTypeId)
            {
                ...
                if (repo.DoesOperationExist(model.loanId, model.operationTypeId, (short)model.loanSystemTypeId))
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("The requested operation already exist and going through approval") });
                }
        ...
        public async Task<HttpResponseMessage> SendEmailForRecovery( int accreditedConsultantId)
        {
            
                var data = await repo.SendEmailToRecoveryAgent(token.GetCompanyId,token.GetStaffId,(short)token.GetBranchId, accreditedConsultantId);
                if (data == false)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> BulkRecoveryReportingAwaitingApprovalList()
        {
            var data = await repo.BulkRecoveryReportingApplicationList(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getBulkRecoveryReportingAwaitingApprovalList()
        {
            var data = await repo.GetBulkRecoveryReportingAwaitingApprovalList(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllLoansRecoveryReportingByReference(string reference)
        {
            var data = await repo.getAllLoansRecoveryReportingByReference(token.GetStaffId, token.GetCompanyId, reference);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GoForRecoveryReportingApproval([FromBody]ApprovalViewModel entity)
        {
            entity.BranchId = token.GetBranchId;
            entity.companyId = token.GetCompanyId;
            entity.staffId = token.GetStaffId;
            ...
            WorkflowResponse data = await repo.GoForRecoveryReportingApproval(entity);
        ...
        public async Task<HttpResponseMessage> GetBulkRecoveryReportingAwaitingApproval()
        {
            var data = await repo.GetBulkRecoveryReportingAwaitingApproval(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllPaymentRecoveredCommissionByAgent()
        {
            var data = await repo.getAllPaymentRecoveredCommissionByAgent(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> BulkRecoveryCommissionAwaitingApprovalList()
        {
            var data = await repo.BulkRecoveryCommissionApplicationList(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getBulkRecoveryCommissionAwaitingApprovalList()
        {
            var data = await repo.GetBulkRecoveryCommissionAwaitingApprovalList(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> getAllLoansRecoveryCommissionByReference(string reference)
        {
            var data = await repo.getAllLoansRecoveryCommissionByReference(token.GetStaffId, token.GetCompanyId, reference);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetBulkRecoveryCommissionAwaitingApproval()
        {
            var data = await repo.GetBulkRecoveryCommissionAwaitingApproval(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GoForRecoveryApproval([FromBody]ApprovalViewModel entity)
        {
            entity.BranchId = token.GetBranchId;
            entity.companyId = token.GetCompanyId;
            entity.staffId = token.GetStaffId;
            ...
            WorkflowResponse data = await repo.GoForRecoveryCommissionApproval(entity);
        ...
        public async Task<HttpResponseMessage> GoForDocumentationFillingApproval([FromBody]ApprovalViewModel entity)
        {
            entity.BranchId = token.GetBranchId;
            entity.companyId = token.GetCompanyId;
            entity.staffId = token.GetStaffId;
            ...
            bool data = await repo.GoForDocumentationFillingApproval(entity);

            if (data)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                    new { success = true, message = TranslateHelper.get("Approved") });
            }
            else
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("Approval failed") });
        ...
        [HttpPost]
        [ClaimsAuthorization]
        [Route("documentation-filling-approval-lms")]
        public async Task<HttpResponseMessage> GoForLmsDocumentationFillingApproval([FromBody] ApprovalViewModel entity)
        {
            entity.BranchId = token.GetBranchId;
            entity.companyId = token.GetCompanyId;
            entity.staffId = token.GetStaffId;
            ...
            bool data = await repo.GoForLmsDocumentationFillingApproval(entity);
        ...
        public async Task<HttpResponseMessage> GoForBulkInsuranceUploadApproval([FromBody]ApprovalViewModel entity)
        {
            entity.BranchId = token.GetBranchId;
            entity.companyId = token.GetCompanyId;
            entity.staffId = token.GetStaffId;
            ...
            WorkflowResponse data = await repo.GoForBulkInsuranceUploadApproval(entity);
        ...
        public async Task<HttpResponseMessage> GoForMultipleBulkInsuranceUploadApproval(int approvalStatusId, string comment, [FromBody] List<MultipleInsuranceOutputViewModel> entity)
        {
            ...
            WorkflowResponse res = await repo.GoForMultipleBulkInsuranceUploadApproval(entity, user, approvalStatusId, comment);
        ...
        public async Task<HttpResponseMessage> GetAllRecoveryAgents()
        {
            var data = await repo.GetAllRecoveryAgents(token.GetStaffId, token.GetCompanyId);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetAllRecoveryCustomersAssignedToAgent(int recoveryAgent)
        {
            var data = await repo.GetAllRecoveryCustomersAssignedToAgent(recoveryAgent);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
        ...
        public async Task<HttpResponseMessage> GetAllInternalRecoveryAgents([FromUri] DateTime start)
        {
            var data = await repo.GetAllInternalRecoveryAgents(token.GetStaffId, token.GetCompanyId, start);
            if (data == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("No Record Found") });
