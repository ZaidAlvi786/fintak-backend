...
namespace FintrakBanking.APICore.Controllers
{
    ...
    public class FXAccountController : ApiControllerBase
    {
        ...
        public async Task<HttpResponseMessage> GetAllGLSubHead(string schemeCode)
        {
            try
            {
                var data = await repo.GetAllGLSubHead(schemeCode);
            ...
            try
            {
                ...
                if (data != null)
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, result = data, message = TranslateHelper.get("The account has been created successfully. Account Number is") + " " + data });
                }
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = TranslateHelper.get("There was an error creating this account") });
            }
