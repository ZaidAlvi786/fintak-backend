...
namespace FintrakBanking.APICore.Controllers
{
    ...
    public class DepartmentController : ApiControllerBase
    {
        ...
        [Route("department")]
        public async Task<HttpResponseMessage> AddDepartment(DepartmentViewModel entity)
        {
            if (entity == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("Empty Record") });
            }
            ...
            try
            {
                ...
                var department = await repo.AddDepartment(entity);
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = department, message = TranslateHelper.get("The record has been created successfully") });
            }
      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public HttpResponseMessage GetAllDepartment()
        {
            ...
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("No department found") });
            }
      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public HttpResponseMessage GetAllUnits()
        {
         ...
         [HttpPost] [ClaimsAuthorization]
        [Route("unit")]
        public async Task<HttpResponseMessage> AddUnit(DepartmentViewModel entity)
        {
            if (entity == null)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("Empty Record") });
            ...
            try
            {
                ...
                entity.createdBy = token.GetStaffId;
                entity.companyId = token.GetCompanyId;
                var unit = await repo.AddUnit(entity);
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = unit, message = TranslateHelper.get("The record has been created successfully") });
            }
            catch (SecureException ex)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get(ex.Message) });
       ...
       [HttpPut] [ClaimsAuthorization]
        [Route("unit/{unitId}")]
        public async Task<HttpResponseMessage> UpdateUnit(short unitId, DepartmentViewModel entity)
        {
            try
            {
                entity.userBranchId = (short)token.GetBranchId;
                entity.applicationUrl = HttpContext.Current.Request.Path;
                entity.createdBy = token.GetStaffId;
                var data = await repo.UpdateUnit(unitId, entity);
                if (data)
                {
        ...
        public async Task<HttpResponseMessage> DeleteUnit(int id)
        {
            try
            {
                ...
                bool data = await repo.DeleteUnit(user,  id);
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = data, message = TranslateHelper.get("The record has been updated successfully") });
            }
            catch (SecureException ex)
            {
      ...
      [HttpGet] [ClaimsAuthorization]  
       ...
       [HttpPut] [ClaimsAuthorization]
        [Route("department/{departmentId}")]
        public async Task<HttpResponseMessage> UpdateDepartment(int departmentId, DepartmentViewModel entity)
        {
            try
            {
                entity.userBranchId = (short)token.GetBranchId;
                entity.applicationUrl = HttpContext.Current.Request.Path;
                entity.createdBy = token.GetStaffId;
                var data = await repo.UpdateDepartment(departmentId, entity);
                if (data)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = data, message = TranslateHelper.get("The record has been updated successfully") });
                }
