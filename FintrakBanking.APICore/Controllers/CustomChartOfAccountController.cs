...
namespace FintrakBanking.APICore.Controllers
{
    ...
    public class CustomChartOfAccountController : ApiControllerBase
    {
        ...
        public async Task<HttpResponseMessage> GetCustomChartOfAccount(int customChartOfAccountId)
        {
            try
            {
                var data = await repo.GetCustomChartOfAccount(customChartOfAccountId);
        ...
        [HttpPost]
        [Route("custom-chart-of-account")]
        public async Task<HttpResponseMessage> AddCustomChartOfAccount([FromBody] CustomChartOfAccountViewModel entity)
        {
            try
            {
                ...
                var data = await repo.AddCustomChartOfAccount(entity);
                if (data)
                {
        ...
        [HttpPut]
        [Route("custom-chart-of-account/{accountId}")]
        public async Task<HttpResponseMessage> UpdateCustomChartOfAccount([FromBody] CustomChartOfAccountViewModel entity, int accountId)
        {
            try
            {
                entity.userBranchId = (short)token.GetBranchId;
                ...
                var data = await repo.UpdateCustomChartOfAccount(entity, accountId);
                if (data)
                {
