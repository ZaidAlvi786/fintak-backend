...
namespace FintrakBanking.APICore.Controllers
{
    ...
    public class ProductDocumentMapingController : ApiControllerBase
    {
        ...
        public async Task<HttpResponseMessage> GetDocumentCategorys()
        {
            IEnumerable<DocumentCategoryViewModel> response = await repo.GetDocumentCategorys();
        ...
        [ClaimsAuthorization]
        [Route("document-category")]
        public async Task<HttpResponseMessage> AddDocumentCategory([FromBody] DocumentCategoryViewModel model)
        {
            ...
            var response = await repo.AddDocumentCategory(model);
        ...
        [ClaimsAuthorization]
        [Route("document-category/{id}")]
        public async Task<HttpResponseMessage> UpdateDocumentCategory([FromBody] DocumentCategoryViewModel model, int id)
        {
            ...
            bool response = await repo.UpdateDocumentCategory(model,id,user);
        ...
        [ClaimsAuthorization]
        [Route("document-category/{id}")]
        public async Task<HttpResponseMessage> DeleteDocumentCategory(int id)
        {
            UserInfo user = new UserInfo()
            {
                BranchId = token.GetBranchId,
            ...
            bool response = await repo.DeleteDocumentCategory(id,user);
