    ...
    public class LoanRecoveryController : ApiControllerBase
    {
        ...
        public HttpResponseMessage AddLoanRecovery( [FromBody]LoanRecoverySetupViewModel entity)
        {
            ...
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = LoanRecovery, message = TranslateHelper.get("The record has been created successfully") });
            }
      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public HttpResponseMessage GetAllLoanRecovery()
        {
            ...
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("No LoanRecovery found")});
            }
      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public HttpResponseMessage GetAllProductType()
        {
            ...
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("No Message Type found") });
            }
            catch (SecureException e)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, Message = e.Message });
       ...
       [HttpPut] [ClaimsAuthorization]
        ...
        public HttpResponseMessage UpdateLoanRecovery(int recoveryPlanId, LoanRecoverySetupViewModel entity)
        {
            try
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error updating this group") + " " +  data });
            }
            catch (SecureException e)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("There was an error updating this group") + " "+ TranslateHelper.get(e.Message) });
            }
        }
      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public HttpResponseMessage GetDistinctLoanRecoveryPaymentPlan()
        {
            ...
            try 
            {
                ...
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = TranslateHelper.get("No LoanRecoveryPaymentPlan found") });
            }
            catch (SecureException e)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, Message = e.Message });
