...
namespace FintrakBanking.APICore.Controllers
{
    ...
    public class EndOfDayController : ApiControllerBase
    {
        ...
        public HttpResponseMessage RunEndOfDay([FromBody] EndOfDayViewModel model)
        {
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                           new { success = true, message = TranslateHelper.get("End of day transaction completed successfully") });
            }
            else
                return Request.CreateResponse(HttpStatusCode.OK,
                           new { success = false, message = TranslateHelper.get("End of day transaction failed") });
        ...
        public HttpResponseMessage RefreshLoanClassification()
        {
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                           new { success = true, message = TranslateHelper.get("Refresh Flexcube Bulk Posting Transaction Completed Successfully") });
            }
            else
                return Request.CreateResponse(HttpStatusCode.OK,
                           new { success = false, message = TranslateHelper.get("Refresh Flexcube Bulk Posting Transaction Failed") });
        ...
        public HttpResponseMessage DeactivateInactiveUsers()
        {
            ...
            return Request.CreateResponse(HttpStatusCode.OK,
                       new { success = true, message = TranslateHelper.get("Inactive Users Deactivated successfully") });
...
<!-- Auto-push timestamp: 2026-05-15 22:41:56 -->