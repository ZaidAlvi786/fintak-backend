    ...
    public class CustomerCreditBureauController : ApiControllerBase
    {
      ...
      [HttpGet] [ClaimsAuthorization]  
        ...
        public HttpResponseMessage GetCreditBureauCustomerDetailsByCustomerId(int customerId)
        {
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = $" {TranslateHelper.get(ce.Message)}" });
            }
            catch (BadLogicException be)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = $"{TranslateHelper.get(be.Message)}" });
            }
            catch (APIErrorException ae)
            {
                return Request.CreateResponse(HttpStatusCode.OK, new { success = false, message = $"{TranslateHelper.get(ae.Message)}" });
            }
            catch (SecureException e)
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                   new { success = false, message = $"{TranslateHelper.get("Error")}: {TranslateHelper.get(e.Message)}" });
            }
        }
        ...
        public HttpResponseMessage AddCustomerCreditBureauCharge(LoanCreditBureauViewModel model)
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                                            new { success = true, date = result, message = model.creditBureauName + " " + TranslateHelper.get("Credit Bureau Report Successfully Saved") });
                }
                else
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, message = model.creditBureauName +  " " + TranslateHelper.get("report upload failed") });
                }
            }
            catch (SecureException ex)
            {
            ...
            try
            {
                ...
                if (data)
                {
                    if (status) return Request.CreateResponse(HttpStatusCode.OK,
                          new { success = true, result = data, message = entity.creditBureauName + " " + TranslateHelper.get("report is positive") });
                    else return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = true, result = data, message = entity.creditBureauName + " " + TranslateHelper.get("report is negative") });
                }
       ...
       [HttpPut] [ClaimsAuthorization]
        ...
        public async Task<HttpResponseMessage> AddCreditBureauReportDocument()
        {
            try
            {
                ...
                {
                    return Request.CreateResponse(HttpStatusCode.OK,
                                           new { success = true, data = result, message = loanCreditBureauModel.creditBureauName + " " + TranslateHelper.get("Credit Bureau Report Successfully Saved") });
                }

                return Request.CreateResponse(HttpStatusCode.OK,
                        new { success = false, message = loanCreditBureauModel.creditBureauName +  " "+ TranslateHelper.get("report upload failed") });
            }
            catch (SecureException ex)
            {
        ...
        public async Task<HttpResponseMessage> GetFullSearchResultInPDF([FromBody] SearchInput searchInput)
        {
            try
            {
                ...
                var result = await repo.GetXDSFullSearchResultInPDF(searchInput);
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                    new { success = false, message = $"{TranslateHelper.get("Error")}: An unhandles error occured"+ex.Message });
            }
        }
        ...
        public async Task<HttpResponseMessage> GetCRCFullCreditMergeReport([FromBody] MultiHitRequestViewModel searchInput)
        {
            try
            {
                searchInput.applicationUrl = HttpContext.Current.Request.Path;
                ...
                var result = await repo.GetCRCFullCreditMergeReport(searchInput);
        ...
        public async Task<HttpResponseMessage> GetCustomerXDSCreditMatch([FromBody] CreditBureauSearchViewModel searchInfoList)
        {
            try
            {
                ...
                var result = await repo.GetCustomerXDSCreditMatch(searchInfoList);
            ...
            {
                return Request.CreateResponse(HttpStatusCode.OK,
                    new { success = false, message = $"{TranslateHelper.get("Error")}: An unhandled error occured." });
            }
        }
        ...
        public async Task<HttpResponseMessage> GetCustomerCRCCreditMatch([FromBody] CRCRequestViewModel searchInfo)
        {
            try
            {
                ...
                var result = await repo.GetCustomerCRCCreditMatch(searchInfo);
