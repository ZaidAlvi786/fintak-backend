    ...
    public class CustomFieldController : ApiControllerBase
    {
        ...
        public HttpResponseMessage AddCustomField([FromBody] AddCustomFieldViewModel model)
        {
            ...
            try
            {
                ...
                if (data)
                {
                    return Request.CreateResponse(HttpStatusCode.OK, new { success = true, result = model, message = TranslateHelper.get("The record has been created successfully") });
                }
       ...
       [HttpPut] [ClaimsAuthorization]
        ...
        public HttpResponseMessage UpdateCustomField([FromBody] AddCustomFieldViewModel model, int id)
        {
              ...
              try
              {
                ...
                var data = repo.UpdateCustomField(model, id).IsCompleted;
                  ...
                  if (data)
                  {
                    return Request.CreateResponse(HttpStatusCode.OK,   new { success = true, result = model, message = TranslateHelper.get("The record has been Update successfully") });
                  }
        ...
        public HttpResponseMessage AddCustomFields([FromBody] List<CustomFieldViewModel> listEntity)
        {
                ...
                try
                {
                    ...
                    if (data)
                    {
                    return Request.CreateResponse(HttpStatusCode.OK,  new { success = true, result = listEntity, message = TranslateHelper.get("The record has been created successfully") });
                    }
       ...
       [HttpPut] [ClaimsAuthorization] [Route("custom-field-multiple")]
        public HttpResponseMessage UpdateCustomFields([FromBody] List<CustomFieldViewModel> listEntity)
        {
                ...
                try
                {
                    ...
                    if (data)
                    {
                    return Request.CreateResponse(HttpStatusCode.OK,  new { success = true, result = listEntity, message = TranslateHelper.get("The record has been Update successfully") });
                    }
