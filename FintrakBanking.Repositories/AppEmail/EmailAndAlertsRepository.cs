    ...
    public class EmailAndAlertsRepository : IEmailAndAlertsRepository
    {
        ...
        public void SendAlertsForCovenantsApproachingDueDateToRM(List<LoanCovenantDetailViewModel> loanDetails, string title, string carbonCopy)
        {
            try
            {
                ...
                foreach (var mailItem in staffList)
                {
                    ...
                    dataTable =
                        $"<table><tr><th>{TranslateHelper.get("Application Ref")}</th><th>{TranslateHelper.get("Covenant Detail")}</th><th>{TranslateHelper.get("Covenant Type")}</th>" +
                        $"<th>{TranslateHelper.get("Amount")}</th><th>{TranslateHelper.get("Covenant Date")}</th><th>{TranslateHelper.get("Due Date")}</th></tr>";
                    ...
                    string messageContent = $"Dear {mailItem.FIRSTNAME + " " + mailItem.LASTNAME}, <br /><br />" +
                                     $"{TranslateHelper.get("This is to bring your attention the following loan covenants")} " +
                                     $"{TranslateHelper.get("which are approaching their due date for revaluation.")} <br /><br />" +
                                     $"{dataTable}";
        ...
        public void SendAlertsForCovenantsOverDue(string title, string messageBody, List<TBL_MONITORING_ALERT_SETUP> alertSetups)
        {
            ...
            try
            {
                ...
                foreach (var mailItem in staffList)
                {
                    ...
                    var messageContent = $"{TranslateHelper.get("Dear")} {mailItem.FirstName + " " + mailItem.LastName}, <br /><br />" + messageBody +
        ...
        public void SendAlertsForCollateralPropertyRevaluation(string title, string messageBody)
        {
            ...
            try
            {
                ...
                foreach (var mailItem in staffList)
                {
                    ...
                    dataTable =
                            $"<table><tr><th>{TranslateHelper.get("Collateral Code")}</th><th>{TranslateHelper.get("Collateral Type")}</th>" +
                            $"<th>{TranslateHelper.get("Collateral Sub Type")}</th><th>{TranslateHelper.get("Property")}</th><th>{TranslateHelper.get("Last Valuation Date")}</th></tr>";
        ...
        public void SendAlertsForLoanNplMonitoring(string title, string messageBody)
        {
            ...
            try
            {
                ...
                {
                    dataTable =
                        $"<table><tr><th>{TranslateHelper.get("Loan Ref")} #</th><th>{TranslateHelper.get("Loan Type")}</th><th>{TranslateHelper.get("Outstanding Interest")}</th><th>{TranslateHelper.get("Oustanding Principal")}</th>" +
                        $"<th>{TranslateHelper.get("Booking Date")}</th><th>{TranslateHelper.get("Disbursed Date")}</th></tr>";
        ...
        public void SendAlertsOnSelfLiquidatingLoanExpiry(string title, string messageBody)
        {
            ...
            try
            {
                ...
                {
                    dataTable =
                            $"<table><tr><th>{TranslateHelper.get("Loan Ref")} #</th><th>{TranslateHelper.get("Product")}</th><th>{TranslateHelper.get("Loan Type")}</th><th>{TranslateHelper.get("Product Type")}</th><th>{TranslateHelper.get("Outstanding Interest")}</th>" +
                            $"<th>{TranslateHelper.get("Oustanding Principal")}</th><th>{TranslateHelper.get("Disbursed Date")}</th><th>{TranslateHelper.get("Maturity Date")}</th></tr>";
                    ...
                    string messageContent = $"{TranslateHelper.get("Dear")} {mailItem.FirstName + " " + mailItem.LastName}, <br /><br />" + messageBody +
        ...
        public void SendAlertsOnOverDraftLoansAlmostDue(string title, string messageBody)
        {
            ...
            try
            {
                ...
                {
                    dataTable =
                            $"<table><tr><th>{TranslateHelper.get("Loan Ref")} #</th><th>{TranslateHelper.get("Product")}</th><th>{TranslateHelper.get("Loan Type")}</th><th>{TranslateHelper.get("Product Type")}</th>" +
                            $"<th>{TranslateHelper.get("Overdraft Limit")}</th><th>{TranslateHelper.get("Disbursed Date")}</th><th>{TranslateHelper.get("Maturity Date")}</th></tr>";
        ...
        public void SendAlertsForExpiredInsurance(string title, string messageBody)
        {
            ...
            try
            {
                ...
                foreach (var mailItem in staffList)
                {
                    ...
                    dataTable =
                            $"<table><tr><th>{TranslateHelper.get("Collateral Code")}</th><th>{TranslateHelper.get("Collateral Type")}</th>" +
                            $"<th>{TranslateHelper.get("Collateral Sub Type")}</th><th>{TranslateHelper.get("Customer Name")}</th><th>{TranslateHelper.get("Property")}</th><th>{TranslateHelper.get("Last Valuation Date")}</th><th>{TranslateHelper.get("Collateral Value")}</th>" +
                            $"<th>{TranslateHelper.get("Valuation Cycle")}</th><th>{TranslateHelper.get("Insurance Company")}</th><th>{TranslateHelper.get("Start Date")}</th><th>{TranslateHelper.get("End Date")}</th></tr>";
        ...
        public void SendAlertsOnLoanCASAwithPND(string title, string messageBody)
        {
            ...
            try
            {
                ...
                {
                    dataTable =
                             $"<table><tr><th>{TranslateHelper.get("Loan Ref")} #</th><th>{TranslateHelper.get("Customer Name")}</th><th>{TranslateHelper.get("Principal Amount")}</th><th>{TranslateHelper.get("Outstanding Principal")}</th>" +
                        $"<th>{TranslateHelper.get("Tenor")} </th><th>{TranslateHelper.get("Interest Rate")}</th><th>{TranslateHelper.get("Booking Date")}</th><th>{TranslateHelper.get("Effective Date")}</th><th>{TranslateHelper.get("Maturity Date")}</th></tr>";
        ...
        public void SendAlertsOnLoanForInActiveBondAndGuarantee(string title, string messageBody)
        {
            ...
            try
            {
                ...
                {
                    dataTable =
                             $"<table><tr><th>{TranslateHelper.get("Loan Ref")} #</th><th>{TranslateHelper.get("Customer Name")}</th><th>{TranslateHelper.get("Contingent Amount")}</th><th>{TranslateHelper.get("exchange Rate")}</th>" +
                        $"<th>{TranslateHelper.get("Booking Date")}</th><th>{TranslateHelper.get("Effective Date")}</th><th>{TranslateHelper.get("Maturity Date")}</th></tr>";
        ...
        public async Task<bool> UpdateMailDeliveryStatus(int messageId, short statusId)
        {
