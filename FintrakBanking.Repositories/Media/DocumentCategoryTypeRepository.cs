...
namespace FintrakBanking.Repositories.Media
{
    public class DocumentCategoryTypeRepository : IDocumentCategoryTypeRepository
    {
        ...
        public async Task<bool> AddDocumentCategoryType(DocumentCategoryTypeViewModel model)
        {
        ...
        public async Task<bool> UpdateDocumentCategoryType(DocumentCategoryTypeViewModel model, int id, UserInfo user)
        {
        ...
        public async Task<bool> DeleteDocumentCategoryType(int id, UserInfo user)
        {
            var entity = this.context.TBL_DOCUMENT_CATEGORY_TYPE.Find(id);
            entity.DELETED = true;
