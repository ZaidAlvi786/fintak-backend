...
namespace FintrakBanking.Repositories.Media
{
    public class DocumentCategoryRepository : IDocumentCategoryRepository
    {
        ...
        public async Task<IEnumerable<DocumentCategoryViewModel>> GetDocumentCategorys()
        {
            var docCategories = await context.TBL_DOCUMENT_CATEGORY.Where(x => x.DELETED == false)
        ...
        public async Task<bool> AddDocumentCategory(DocumentCategoryViewModel model)
        {
        ...
        public async Task<bool> UpdateDocumentCategory(DocumentCategoryViewModel model, int id, UserInfo user)
        {
        ...
        public async Task<bool> DeleteDocumentCategory(int id, UserInfo user)
        {
            var entity = this.context.TBL_DOCUMENT_CATEGORY.Find(id);
            entity.DELETED = true;
