    ...
    public class LoanDocumentRepository : ILoanDocumentRepository
    {
        ...
        public int AddLoanDocument(LoanDocumentViewModel model, byte[] file)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Added Loan Document with title")} : '{ model.documentTitle }' ",
        ...
        public bool UpdateLoanDocument(LoanDocumentViewModel model, int documentId, byte[] file)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated Loan Document with title")} : '{ model.documentTitle }' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        {
            result = this.docContext.TBL_TEMP_MEDIA_LOAN_DOCUMENTS.Where(x => x.TEMPLOANREVIEWOPERATIONID == operationReviewId && x.DELETED == false)
        ...
        public bool AddCommitteeDocument(LoanDocumentViewModel model, byte[] file)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Added Committee Minutes")} '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool AddCreditBureauReportDocument(LoanDocumentViewModel model, byte[] file)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Credit Bureau Report Document with title")} : '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool UpdateCreditBureauReportDocument(LoanDocumentViewModel model, int documentId)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = model.lastUpdatedBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated Credit Bureau Report Document with title")} : '{ model.documentTitle }' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public bool AddConditionDocument(LoanDocumentViewModel model, byte[] file)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Added Condition Document with title")} : '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool UpdateConditionDocument(LoanDocumentViewModel model)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Updated Loan Condition Document with title")} : '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool UpdateMediaCheckListDocument(LoanDocumentViewModel model)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Update media check list Document with title")} : '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool AddMediaCollateralDocument(LoanDocumentViewModel model, byte[] file)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Added Media Collateral Document with title")} : '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool UpdateMediaCollateralDocument(LoanDocumentViewModel model, byte[] file)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Updated Media Collateral Document with title")} : '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool AddMediaJobRequestDocument(LoanDocumentViewModel model, byte[] file)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Added Media Job Request Document with title")} : '{ model.documentTitle }' ",
                    IPADDRESS =CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool UpdateMediaJobRequestDocument(LoanDocumentViewModel model)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Update Media Job Request Document with title")} : '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool AddMediaKYCDocument(LoanDocumentViewModel model, byte[] file)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Added Media KYC Document with title")} : '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool UpdateMediaKYCDocument(LoanDocumentViewModel model)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Update Media KYC Document with title")} : '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool UpdateMediaStaffPicture(LoanDocumentViewModel model)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Updated Media Staff Picture with title")} : '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool AddMediaStaffSignature(LoanDocumentViewModel model, byte[] file)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Added Media Staff Signature with title")} : '{ model.documentTitle }' ",
                    IPADDRESS =CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public bool UpdateMediaStaffSignature(LoanDocumentViewModel model)
        {
            try
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = model.createdBy,
                    BRANCHID = (short)model.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Update Media Staff Signature with title")} : '{ model.documentTitle }' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
