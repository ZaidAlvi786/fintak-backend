...
namespace FintrakBanking.Repositories.credit
{
    public class LcUssanceRepository : ILcUssanceRepository
    {
        ...
        public async Task< IEnumerable<LcUssanceViewModel>> GetLcUssances()
        {
        ...
        public async Task<List<LcUssanceViewModel>> GetLcUssanceExtensionsByLcUsanceId(int lcUsanceId)
        {
        ...
        public async Task< LcUssanceViewModel> GetLcUssanceExtensionByTempLcUsanceId(int tempLcUsanceId)
        {
        ...
        public async Task<LcUssanceViewModel> GetLcUssanceByLCUsanceId(int lcUsanceId)
        {
        ...
        public async Task<List<LcUssanceViewModel>> GetLcUssanceByLCIssuanceId(int lcIssuanceId)
        {
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForUssanceExtension(int staffId)
        {
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForUssance(int staffId)
        {
            var staffs = general.GetStaffRlieved(staffId).ToList();
            var lcsInProgress = (from x in context.TBL_LC_ISSUANCE
                       join u in context.TBL_LC_USSANCE on x.LCISSUANCEID equals u.LCISSUANCEID
        ...
        public async Task<LcUssanceViewModel> AddLcUssance(LcUssanceViewModel model)
        {
            model = await ValidateUsanceAmount(model);
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                DETAIL = $"TBL_LC_USSANCE '{entity.ToString()}' {TranslateHelper.get("created by")} {auditStaff}",
        ...
        public async Task<LcUssanceViewModel> AddLcUssanceExtension(LcUssanceViewModel model)
        {
            var reference = CommonHelpers.GenerateRandomDigitCode(10);
            var us = context.TBL_LC_USSANCE.Find(model.lcUssanceId);
            if (us == null)
            {
                throw new SecureException(TranslateHelper.get("LC Usance for Extension cannot be null!"));
            }
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = model.createdBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"TBL_LC_USSANCE EXTENSION '{entity.ToString()}' {TranslateHelper.get("created by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        private async Task<LcUssanceViewModel> ValidateUsanceAmount(LcUssanceViewModel model)
        {
            ...
            {
                throw new SecureException(TranslateHelper.get("Usance Amount cannot be greater than tolerance amount ") + availableAmount);
            }
            model.ussanceAmountLocal = lcUssanceAmount;
            return model;
        }

        public async Task<bool> UpdateLcUsanceExtension(LcUssanceViewModel model, int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                DETAIL = $"TBL_LC_USSANCE EXTENSION'{entity.ToString()}' {TranslateHelper.get("was updated by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
        ...
        public async Task<bool> UpdateLcUssance(LcUssanceViewModel model, int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_LC_USSANCE '{entity.ToString()}' {TranslateHelper.get("was updated by")} {auditStaff}",
                IPADDRESS =CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<bool> DeleteLcUssance(int id, UserInfo user)
        {
            var entity = this.context.TBL_LC_USSANCE.Find(id);
            entity.DELETED = true;
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_LC_USSANCE '{entity.ToString()}' {TranslateHelper.get("was deleted by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForUssanceExtensionApproval(int staffId)
        {
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForUssanceApproval(int staffId)
        {
