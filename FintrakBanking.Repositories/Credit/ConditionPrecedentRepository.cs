...
namespace FintrakBanking.Repositories.Credit
{
    public class ConditionPrecedentRepository : IConditionPrecedentRepository
    {
        ...
        public async Task<List<ConditionPrecedentViewModel>> GetConditionPrecedentDefaultByDetailId(int detailId)
        {
        ...
        public async Task<List<ConditionPrecedentViewModel>> GetConditionPrecedentDefaultByDetailIdLms(int detailId)
        {
        ...
        public async Task<bool> AddConditionPrecedent(ConditionPrecedentViewModel model)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Added Condition Precedent")} '{ model.conditionId }' ",
        ...
        public bool EditLoanConditionPrecedent(int id, ConditionPrecedentViewModel model)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated Condition Precedent")} '{ model.conditionId }' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public async  Task<List<ConditionPrecedentViewModel>> GetConditionPrecedentDefaultByApplicationIdAndOperationLms(int detailId, int? operationId)
        {
            var applicationDetail = context.TBL_LMSR_APPLICATION_DETAIL.Find(detailId);
        ...
        {
            var result = this.context.TBL_CONDITION_PRECEDENT.Where(x=> x.DELETED == false)
        ...
        public async  Task<bool> AddConditionPrecedentTemplate(ConditionPrecedentViewModel model)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = model.createdBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"{TranslateHelper.get("Added Condition Precedent template")} '{ model.conditionId }' ",
                IPADDRESS =CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<bool> UpdateConditionPrecedentTemplate(ConditionPrecedentViewModel model, int conditionId)
        {
            ...
            data.SUBSECTORID = model.subSectorId;
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = model.lastUpdatedBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated Condition Precedent template")} '{ model.conditionId }' ",
                IPADDRESS =CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<bool> RemoveLoanConditionPrecedent(int id, UserInfo model)
        {
            var data = this.context.TBL_LOAN_CONDITION_PRECEDENT.Find(id);
            if (data == null)
            {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Remove Condition Precedent")} '{ data.CONDITION }' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public bool AddComplianceTimelineTemplate(ComplianceTimelineViewModel model)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = model.createdBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"{TranslateHelper.get("Added Condition Precedent template")} '{ model.timelineId }' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public bool UpdateComplianceTimelineTemplate(ComplianceTimelineViewModel model, int timelineId)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = model.lastUpdatedBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated Condition Precedent template")} '{ model.timelineId }' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<bool> RemoveComplianceTimelineTemplate(UserInfo user, int timelineId)
        {
            var data = this.context.TBL_COMPLIANCE_TIMELINE.Find(timelineId);
            if (data == null)
            {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Delete timeline for compliance")}'{ timelineId }' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
        ...
        public async Task<bool> DeleteConditionPrecedentTemplate(UserInfo user, int id)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = user.staffId,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"{TranslateHelper.get("Delete Condition Precedent")} '{ id }' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<bool> RemoveLoanConditionPrecedentLms(int id, UserInfo model)
        {
        ...
        public async Task<bool> EditLoanConditionPrecedentLms(int id, ConditionPrecedentViewModel model)
        {
            var data = this.context.TBL_LMSR_CONDITION_PRECEDENT.Find(id);
            if (data == null)
            {
        ...
        public async Task<List<ConditionPrecedentViewModel>> AddSelectedConditionPrecedentLms(SelectedIdsViewModel entity)
        {
        ...
        public async Task<bool> AddConditionPrecedentLms(ConditionPrecedentViewModel model)
        {
        ...
        public async Task<List<AdditionalCommentViewModel>> GetAdditionalComment(int applicationId, int callerId, int staffId)
        {
        ...
        public async Task<bool> AddAdditionalComment(AdditionalCommentViewModel model)
        {
            ...
            if (model.isRemoteCall == true)
            {
               ...
               // var staffId = context.TBL_STAFF_REMOTE_NT_IDS.Where(x => x.LOCALNETWORKID == model.createdBy).FirstOrDefault().REMOTENETWORKID;
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = staffId,
                    BRANCHID = 94,
                    DETAIL = TranslateHelper.get("Added Additional Comment Condition "),
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<bool> EditAdditionalComment(int id, AdditionalCommentViewModel model)
        {
            var data = context.TBL_LOAN_APPLICATION_COMMENT.Where(x=>x.LOANCOMMENTID == model.selectedId).FirstOrDefault();
            if (data == null) { data = this.context.TBL_LOAN_APPLICATION_COMMENT.Find(id); }
            if (data == null) return false;

            data.COMMENTS = model.additionalComment;
            data.LOANAPPLICATIONID = model.applicationId;
            data.DATETIMEUPDATED = DateTime.Now;
//          data.LASTUPDATEDBY = model.lastUpdatedBy;
            ...
            if (model.isRemoteCall == true)
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = staffId,
                    BRANCHID = 94,
                    DETAIL = TranslateHelper.get("Updated Additional Comment Condition"),
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = model.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<bool> RemoveAdditionalComment(int id, UserInfo user)
        {
            ...
            {
                var staffId = context.TBL_STAFF_REMOTE_NT_IDS.Where(x => x.LOCALNETWORKID == user.createdBy).FirstOrDefault().REMOTENETWORKID;
                var audit = new TBL_AUDIT
                {
                    AUDITTYPEID = (short)AuditTypeEnum.ConditionPrecedentUpdated,
                    STAFFID = staffId,
                    BRANCHID = 94,
                    DETAIL = TranslateHelper.get("Deleted Additional Comment Condition"),
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = user.applicationUrl,
                    APPLICATIONDATE = general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
