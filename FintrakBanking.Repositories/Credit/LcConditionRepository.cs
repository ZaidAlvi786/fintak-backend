...
namespace FintrakBanking.Repositories.credit
{
    public class LcConditionRepository : ILcConditionRepository
    {
        ...
        public async Task<IEnumerable<LcConditionViewModel>> GetLcConditions()
        {
        ...
        public async Task<IEnumerable<LcConditionViewModel>> GetLcConditionsBylcIssuanceId(int lcIssuanceId)
        {
        ...
        public async Task<LcConditionViewModel> GetLcCondition(int id)
        {
        ...
        public async Task<bool> AddLcCondition(LcConditionViewModel model)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                DETAIL = $"TBL_Lc Condition '{entity.ToString()}' {TranslateHelper.get("created by")} {auditStaff}",
        ...
        public async Task<bool> UpdateLcCondition(LcConditionViewModel model, int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                DETAIL = $"TBL_Lc Condition '{entity.ToString()}' {TranslateHelper.get("was updated by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),            
        ...
        public async Task<bool> DeleteLcCondition(int id, UserInfo user)
        {
            var entity = this.context.TBL_LC_CONDITION.Find(id);
            entity.DELETED = true;
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_Lc Condition '{entity.ToString()}' {TranslateHelper.get("was deleted by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
