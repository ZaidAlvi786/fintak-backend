...
namespace FintrakBanking.Repositories.Credit
{
    public class StaffAccountHistoryRepository : IStaffAccountHistoryRepository
    {
       ...
       private FinTrakBankingStagingContext stagingContext;
        ...
        public async Task<IEnumerable<StaffAccountHistoryViewModel>> GetAllStaffAccountHistory()
        {
            List<StaffAccountHistoryViewModel> accountLst = new List<StaffAccountHistoryViewModel>();
            var data = await context.TBL_STAFF_ACCOUNT_HISTORY.Select(sa => new StaffAccountHistoryViewModel
            {
        ...
        public bool AddStaffAccountHistory(StaffAccountHistoryViewModel entity)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = TranslateHelper.get("Initial account reassigned"),
        ...
        public async Task<IEnumerable<StaffAccountHistoryViewModel>> GetStaffAccountHistory(int staffId)
        {
            try
            {
                List<StaffAccountHistoryViewModel> accountLst = new List<StaffAccountHistoryViewModel>();
                ...
                var data =  await (from ln in context.TBL_STAFF_ACCOUNT_HISTORY
        ...
        public async Task<StaffMISHistoryViewModel> GetSelectedApprovalLoanDetails(ReasignedAccountApprovalViewModel entity)
        {
            StaffMISHistoryViewModel data = null;
            if (entity != null)
            {
                var staff = await context.TBL_STAFF_ACCOUNT_HISTORY.Where(s => s.STAFFACCOUNTHISTORYID == entity.staffAccountHistoryId).FirstOrDefaultAsync();

                data = await GetSelectedLoanDetails(entity.companyId, staff.TARGETID, entity.loanSystemTypeId);
        ...
        public async Task<StaffMISHistoryViewModel> GetSelectedLoanDetails(int companyId, int loanId, int loanSystemTypeId)
        {
            ...
            {
                loan = await  GetRunningRevolvingLoans(companyId, loanId);
            }
        ...
        public async Task<bool> ApproveStaffAccountHistory(ReasignedAccountApprovalViewModel entity)
        {
        ...
        private async Task<StaffMISHistoryViewModel> GetRunningRevolvingLoans(int companyId, int loanId)
        {
            var loanDetails =  await (from a in context.TBL_LOAN_REVOLVING
