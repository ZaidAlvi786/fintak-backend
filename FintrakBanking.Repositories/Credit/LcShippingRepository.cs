...
namespace FintrakBanking.Repositories.credit
{
    public class LcShippingRepository : ILcShippingRepository
    {
        ...
        public async Task<IEnumerable<LcShippingViewModel>> GetLcShippings()
        {
        ...
        public async Task<IEnumerable<LcShippingViewModel>> GetLcShippingsByIssuanceId(int lcIssuanceId)
        {
        ...
        public async Task<LcShippingViewModel> GetLcShipping(int id)
        {
        ...
        public async Task<bool> AddLcShipping(LcShippingViewModel model)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                DETAIL = $"TBL_Lc Shipping '{entity.ToString()}' {TranslateHelper.get("created by")} {auditStaff}",
        ...
        public async Task<bool> UpdateLcShipping(LcShippingViewModel model, int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                DETAIL = $"TBL_Lc Shipping '{entity.ToString()}' {TranslateHelper.get("was updated by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
        ...
        public async Task<bool> DeleteLcShipping(int id, UserInfo user)
        {
            var entity = this.context.TBL_LC_SHIPPING.Find(id);
            entity.DELETED = true;
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_Lc Shipping '{entity.ToString()}' {TranslateHelper.get("was deleted by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
