...
namespace FintrakBanking.Repositories.Credit
{
    public class CollateralValuationRepository : ICollateralValuationRepository
    {
        ...
        public async Task<CollateralValuationViewModel> AddCollateralValuation(CollateralValuationViewModel model)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Collateral Valuation for")}  '{ model.collateralValuationId }' {TranslateHelper.get("is added by")} {model.staffId} ",
        ...
        public async Task<ValuationPrerequisiteViewModel> AddValuationPrerequisite(ValuationPrerequisiteViewModel model)
        {
        ...
        public async Task<bool> UpdateValuationPrerequisite(int valuationPrerequisiteId, ValuationPrerequisiteViewModel model)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                BRANCHID = (short) model.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated Valuation Prerequisite for")} '{ model.valuationPrerequisiteId }' ",
                IPADDRESS =CommonHelpers.GetLocalIpAddress(),
                 URL = model.applicationUrl,
                APPLICATIONDATE = _general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<CollateralValuationViewModel> GetCollateralValuation(int collteralValuationId)
        {
        ...
        public async Task<List<ValuationPrerequisiteViewModel>> GetCollateralValuerIformation(int id)
        {
            var data = await (from x in _context.TBL_VALUATION_REPORT
        ...
        public async Task<ValuationPrerequisiteViewModel> GetCollateralValuerIformations(int id)
        {
            var data = await (from x in _context.TBL_VALUATION_REPORT
                        where x.DELETED == false && x.COLLATERALVALUATIONID == id
                        orderby x.VALUATIONREPORTID descending
        ...
        public async Task<List<ValuationPrerequisiteViewModel>> GetAllCollateralValuerIformation()
        {
        ...
        public async Task<ValuationPrerequisiteViewModel> GetAllCollateralValuerIformationById(int id)
        {
            var data = from x in _context.TBL_VALUATION_REPORT
        ...
        public async Task<bool> AddCollateralValurerInfo(ValuationPrerequisiteViewModel model)
        {
            try
            {
            ...
            if (exist == true) throw new SecureException(TranslateHelper.get("This record is already saved!"));
        ...
        public async Task<bool> UpdateCollateralValurerInfo(ValuationPrerequisiteViewModel model)
        {
            try
            {
        ...
        public async Task<bool> UpdateCollateralNarration(ValuationPrerequisiteViewModel model)
        {
            try
            {
                var exist =await _context.TBL_COLLATERAL_VALUATION.FindAsync(model.valuationReportId);
        ...
        public async Task<List<CollateralValuationViewModel>> GetAllCollateralValuations(int collateralId)
        {
        ...
        public async Task<List<ValuationPrerequisiteViewModel>> GetAllValuationPrerequisitesById(int staffId, int collateralValuationId)
        {
            ...
            var result1 = await (from O in _context.TBL_COLLATERAL_VALUATION_PRE
        ...
        public async Task<List<ValuationPrerequisiteViewModel>> GetAllValuationPrerequisitesListById(int staffId, int collateralValuationId)
        {
            var collateralId = _context.TBL_COLLATERAL_VALUATION.Where(x => x.COLLATERALVALUATIONID == collateralValuationId)
                                                                    .Select(x => x.COLLATERALCUSTOMERID).FirstOrDefault();
        ...
        public async Task<WorkflowResponse> GoForCollateralValuationApproval(ValuationPrerequisiteViewModel entity)
        {
            ...
            try
            {
                if (prerequisite != null)
                {
                    ...
                    _workflow.Comment = TranslateHelper.get("Request for collateral valuation approval");
        ...
        public String ResponseMessage(WorkflowResponse response, string itemHeading)
        {
            ...
            else
            {
                ...
                else if(response.statusId == (int)ApprovalStatusEnum.Closed)
                {
        ...
        public async Task<IEnumerable<ValuationPrerequisiteViewModel>> GetAllValuationRequest(int collteralId)
        {
        ...
        public async Task<IEnumerable<ValuationPrerequisiteViewModel>> GetAllValuationRequestList()
        {
            var res = await (from C in _context.TBL_COLLATERAL_CUSTOMER
                       join T in _context.TBL_COLLATERAL_VALUATION on C.COLLATERALCUSTOMERID equals T.COLLATERALCUSTOMERID
                       join V in _context.TBL_COLLATERAL_VALUATION_PRE on T.COLLATERALVALUATIONID equals V.COLLATERALVALUATIONID
                       join atrail in _context.TBL_APPROVAL_TRAIL on V.VALUATIONPREREQUISITEID equals atrail.TARGETID
                       where 
        ...
        public async Task<List<ValuationPrerequisiteViewModel>> GetCollateralValuationPrerequisiteById(int staffId, int valuationPrerequisiteId)
        {
            var ids = _general.GetStaffApprovalLevelIds(staffId, (int) OperationsEnum.CollateralValuationRequest).ToList();
        ...
        public async Task<IEnumerable<ValuationPrerequisiteViewModel>> GetCollateralValuationRequestWaitingForApproval(int staffId)
        {
            var ids = _general.GetStaffApprovalLevelIds(staffId, (int) OperationsEnum.CollateralValuationRequest).ToList();
            var staffs = _general.GetStaffRlieved(staffId);
            //_context.Configuration.ProxyCreationEnabled = false;

            var res = await (from valPre in _context.TBL_COLLATERAL_VALUATION_PRE
                       join q in _context.TBL_COLLATERAL_VALUATION on valPre.COLLATERALVALUATIONID equals q.COLLATERALVALUATIONID
                       join C in _context.TBL_COLLATERAL_CUSTOMER on q.COLLATERALCUSTOMERID equals C.COLLATERALCUSTOMERID
                       join atrail in _context.TBL_APPROVAL_TRAIL on valPre.VALUATIONPREREQUISITEID equals atrail.TARGETID
                       join cus in _context.TBL_CUSTOMER on C.CUSTOMERID equals cus.CUSTOMERID
        ...
        public async Task<List<ValuationPrerequisiteViewModel>> SearchForCollateralValuation(string searchString)
        {
            int[] operations = { (int)OperationsEnum.CollateralValuationRequest };

            searchString = searchString.Trim().ToLower();

            var valuations = await (from valPre in _context.TBL_COLLATERAL_VALUATION_PRE
                                join q in _context.TBL_COLLATERAL_VALUATION on valPre.COLLATERALVALUATIONID equals q.COLLATERALVALUATIONID
                                join C in _context.TBL_COLLATERAL_CUSTOMER on q.COLLATERALCUSTOMERID equals C.COLLATERALCUSTOMERID
                                join atrail in _context.TBL_APPROVAL_TRAIL on valPre.VALUATIONPREREQUISITEID equals atrail.TARGETID
                                join cus in _context.TBL_CUSTOMER on C.CUSTOMERID equals cus.CUSTOMERID
        ...
        public WorkflowResponse SubmitApproval(ValuationPrerequisiteViewModel model)
        {
            ...
            using (var transaction = _context.Database.BeginTransaction())
            {
                ...
                bool isPostApprovalReviewer = _workflow.ApprovalTrail.TBL_APPROVAL_LEVEL.ISPOSTAPPROVALREVIEWER;

                try
                {
                    if (_workflow.NewState != (int)ApprovalState.Ended && !isPostApprovalReviewer)
                    {
                        ...
                        if (staffRole.STAFFROLECODE == "VAL CR DOC OFF" || staffRole.STAFFROLECODE == "VCDF" || staffRole.STAFFROLECODE == "VCDO")
                        {
                        ...
                        if ((staffRole.STAFFROLECODE == "CRDT DOC GH" || staffRole.STAFFROLECODE == "CR DOC MGR" || staffRole.STAFFROLECODE == "CDM") && (prereqisite.NUMBEROFTIMESAPPROVE <= 1 || prereqisite.NUMBEROFTIMESAPPROVE == null) && (valuerReport?.OMV < 1 || valuerReport?.OMV == null))
                        {
                        ...
                        if ((staffRole.STAFFROLECODE == "VAL CR DOC OFF" || staffRole.STAFFROLECODE == "VCDF" || staffRole.STAFFROLECODE == "VCDO") && (prereqisite.NUMBEROFTIMESAPPROVE > 1 && valuerReport?.OMV > 0 && valuerReport?.FSV > 0))
                        {
                            var collateral = _context.TBL_COLLATERAL_VALUATION.Where(o => o.COLLATERALVALUATIONID == valuerReport.COLLATERALVALUATIONID).Select(o => o).FirstOrDefault();
                            var valuer = _context.TBL_COLLATERAL_VALUER.Where(o => o.COLLATERALVALUERID == valuerReport.VALUERID).Select(o => o.NAME).FirstOrDefault();
                            ...
                            tempResult = $@"
                             <table cellpadding='0' cellspacing='0' border='1' width='800px'>
                                <tr>
                                    <td><b>{TranslateHelper.get("PROPERTY ADDRESS")}</b></td>
                                    <td><b>{TranslateHelper.get("OMV")}</b></td>
                                    <td><b>{TranslateHelper.get("FSV")}</b></td>
                                    <td><b>{TranslateHelper.get("VALUATION FEE TO BE DEBITED")}</b></td>
                                </tr>
                             ";
                    ...
                    if(_workflow.NewState != (int)ApprovalState.Ended && isPostApprovalReviewer)
                    {
                        var approvingStaff = _context.TBL_STAFF.Find(model.createdBy);
                        var staffRole = _context.TBL_STAFF_ROLE.Where(r => r.STAFFROLEID == approvingStaff.STAFFROLEID).FirstOrDefault();
                        prereqisite = _context.TBL_COLLATERAL_VALUATION_PRE.Where(O => O.VALUATIONPREREQUISITEID == model.valuationPrerequisiteId && O.APPROVALSTATUSID == (int)ApprovalStatusEnum.Approved).Select(O => O).FirstOrDefault();
                        var valuerReport = _context.TBL_VALUATION_REPORT.Where(o => o.COLLATERALVALUATIONID == prereqisite.COLLATERALVALUATIONID).Select(o => o).FirstOrDefault();
                    }
                    ...
                    if (_workflow.NewState == (int) ApprovalState.Ended && !isPostApprovalReviewer)
                    {
                        ...
                        if (valuerReport != null)
                        {
                            ...
                            //customerCollateral.COLLATERALVALUE = (decimal)valuerReport.FSV; ---both parameters return null and break code---
        ...
        private async Task<string> GetBusinessUsersEmailsToGroupHead(string accountOfficerMIsCode)
        {
            string emailList = "";

            var accountOfficer = await _context.TBL_STAFF.Where(x => x.MISCODE.ToLower() == accountOfficerMIsCode.ToLower()).FirstOrDefaultAsync();
        ...
        public async Task<bool> DeleteValuationPrerequisite(int valuationPrerequisiteId, UserInfo user)
        {
            var prerequisite = await _context.TBL_COLLATERAL_VALUATION_PRE.Where(O => O.APPROVALSTATUSID == (int) ApprovalStatusEnum.Pending 
                                        && O.VALUATIONPREREQUISITEID ==  valuationPrerequisiteId).FirstOrDefaultAsync();
        ...
        public async Task<bool> UpdateValuationPrerequisiteStatus(int valuationPrerequisiteId, UserInfo user)
        {
            var prerequisite = await _context.TBL_COLLATERAL_VALUATION_PRE.Where(O => O.APPROVALSTATUSID == (int)ApprovalStatusEnum.Processing
                                        && O.VALUATIONPREREQUISITEID == valuationPrerequisiteId).FirstOrDefaultAsync();
            ...
            if (prerequisite != null)
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = user.staffId,
                    BRANCHID = (short)user.BranchId,
                    DETAIL = TranslateHelper.get("Updated Valuation Prerequisite with code: ") + prerequisite.VALUATIONPREREQUISITEID,
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = user.applicationUrl,
                    APPLICATIONDATE = _general.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
