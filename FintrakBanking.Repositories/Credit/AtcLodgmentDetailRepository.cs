...
namespace FintrakBanking.Repositories.credit
{
    public class AtcLodgmentDetailRepository : IAtcLodgmentDetailRepository
    {
        ...
        public async Task<IEnumerable<AtcLodgmentDetailViewModel>> GetAtcLodgmentDetail(int id)
        {
            var entity = new List<AtcLodgmentDetailViewModel>();

            entity = await context.TBL_ATC_LODGMENT_DETAIL.Where(x => x.ATCLODGMENTID == id && x.DELETED == false)
        ...
        public async Task<bool> AddAtcLodgmentDetail(AtcLodgmentDetailViewModel model)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("TBL_Atc Lodgment Detail")} '{entity.DETAIL}' {TranslateHelper.get("created by")} {auditStaff}",       
        ...
        public async Task<bool> DeleteAtcLodgmentDetail(int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("TBL_Atc Lodgment Detail")} '{entity.DETAIL}' {TranslateHelper.get("was deleted by")} {auditStaff}",
