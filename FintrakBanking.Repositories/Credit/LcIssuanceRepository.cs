...
namespace FintrakBanking.Repositories.credit
{
    public class LcIssuanceRepository : ILcIssuanceRepository
    {
        ...
        public async Task<List<LcIssuanceApprovalViewModel>> SearchLc(string searchString)
        {
        ...
        public async Task<List<LcIssuanceApprovalViewModel>> SearchLcLMS(string searchString)
        {
        ...
        public async Task<short?> VerifyApplicationStatus(int lcIssuanceId,int operationId)
        {
        ...
        public async Task<LcIssuanceApprovalViewModel> VerifyIssuanceOrReleaseApprovalLevelId(LcIssuanceApprovalViewModel lc)
        {
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuances(int staffId)
        {
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForEnhancement(int staffId)
        {
            var staffs = general.GetStaffRlieved(staffId).ToList();
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForExtension(int staffId)
        {
            var staffs = general.GetStaffRlieved(staffId).ToList();
        ...
        public async Task< IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForApproval(int staffId)
        {
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForEnhancementApproval(int staffId)
        {
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForExtensionApproval(int staffId)
        {
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForCancelationApproval(int staffId)
        {
        ...
        public async Task<IEnumerable<CamProcessedLoanViewModel>> GetIFFLinesForLCByCustomerId(int customerId, int companyId, int staffId, int branchId)
        {
            //var lines = drawdownRepo.GetAvailedLoanApplicationsDueForInitiateBooking(companyId, staffId, branchId, true).ToList();
            var lines = await GetAvailedLoanApplicationsDueForInitiateBooking(staffId, companyId, customerId, branchId);
            ...
            var linesForLC = lines.Where
                (l => l.customerId == customerId && l.productClassId == (int)ProductClassEnum.ImportFinanceFacilities && l.customerAvailableAmount > 0).AsEnumerable();

            return linesForLC;
        }

        private async Task<IEnumerable<CamProcessedLoanViewModel>> GetAvailedLoanApplicationsDueForInitiateBooking(int staffId, int companyId, int customerId, int branchId)
        {
            ...
            //          }).ToList();
            data2 = (List<CamProcessedLoanViewModel>)await drawdownRepo.GetAvailedLoanApplicationsDueForInitiateBooking(companyId, staffId, branchId, customerId, true);
            var data = data2;
        ...
        public async Task<IEnumerable<LcIssuanceViewModel>> GetLcIssuance(int id)
        {
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcEnhancementByLcEnhancementId(int tempLcIssuanceId)
        {
        ...
        public async Task<Tuple<bool, string>> ValidateAmounts(LcIssuanceViewModel model)
        {
            ...
            {
                return new Tuple<bool, string>(false, "LC amount cannot be greater than available amount!");
                //throw new SecureException("LC amount cannot be greater than available amount!");
            }
            return new Tuple<bool, string>(true, "LC amount cannot be greater than available amount!");
        }

        public async Task<LcIssuanceViewModel> AddLcIssuance(LcIssuanceViewModel model)
        {
            var lcAmountValidation = await ValidateAmounts(model);
            if(lcAmountValidation.Item1 == false) { throw new SecureException(lcAmountValidation.Item2);  }
        ...
        public async void ValidateLcEnhancement(LcIssuanceViewModel model)
        {
        ...
        public async void ValidateLcEnhancementUpdate(LcIssuanceViewModel model)
        {
            var lc = context.TBL_LC_ISSUANCE.Find(model.lcIssuanceId);
            if (lc == null)
            {
        ...
        public async Task<LcIssuanceViewModel> AddLcEnhancement(LcIssuanceViewModel model)
        {
        ...
        public async Task<LcIssuanceViewModel> AddLcExtension(LcIssuanceViewModel model)
        {
            ValidateLcEnhancement(model);
            var referenceNumber = CommonHelpers.GenerateRandomDigitCode(10);
        ...
        public async Task<bool> UpdateLcIssuance(LcIssuanceViewModel model, int id, UserInfo user)
        {
        ...
        public async Task<bool> UpdateLcEnhancement(LcIssuanceViewModel model, int id, UserInfo user)
        {
        ...
        public async Task<bool> UpdateLcExtension(LcIssuanceViewModel model, int id, UserInfo user)
        {
            var entity = this.context.TBL_TEMP_LC_ISSUANCE.Find(id);
            ValidateLcEnhancementUpdate(model);
        ...
        public async Task<bool> DeleteLcIssuance(int id, UserInfo user)
        {
            var entity = this.context.TBL_LC_ISSUANCE.Find(id);
            entity.DELETED = true;
        ...
        public async Task<bool> DeleteLcEnhancement(int id, UserInfo user)
        {
            var entity = this.context.TBL_TEMP_LC_ISSUANCE.Find(id);
            entity.DELETED = true;
            entity.DELETEDBY = user.createdBy;
        ...
        public async Task<bool> DeleteLcExtension(int id, UserInfo user)
        {
            var entity = this.context.TBL_TEMP_LC_ISSUANCE.Find(id);
            entity.DELETED = true;
            entity.DELETEDBY = user.createdBy;
        ...
        public async Task<bool> UpdateOldLcWithEnhancement(int tempLcIssuanceId)
        {
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForRelease(int staffId) 
        {
        ...
        public async Task<IEnumerable<LcReleaseAmountViewModel>> GetReleasesForLcIssuance(int lcIssuanceId)
        {
        ...
        public async Task<IEnumerable<LcIssuanceApprovalViewModel>> GetLcIssuancesForReleaseApproval(int staffId)
        {
        ...
        public async Task<LcReleaseAmountViewModel> AddLCReleaseAmount(LcReleaseAmountViewModel entity)
        {
            await ValidateReleaseAmount(entity);
        ...
        public async Task<LcReleaseAmountViewModel> UpdateLCReleaseAmount(LcReleaseAmountViewModel entity)
        {
        ...
        public async Task<LcReleaseAmountViewModel> GetLCReleaseAmount(int lcReleaseAmountId)
        {
        ...
        private async Task<bool> ValidateReleaseAmount(LcReleaseAmountViewModel model)
        {
            var lc = context.TBL_LC_ISSUANCE.Find(model.lcIssuanceId);
