    ...
    public class ProjectSiteReportRepository : IProjectSiteReportRepository
    {
        ...
        public IEnumerable<LoanApplicationViewModel> Search(string searchString)
        {
            var dataTermLoan = (from x in context.TBL_LOAN_APPLICATION
                                ...
                                psrReportTypeId = context.TBL_PSR_REPORT_TYPE.Where(b => b.PSRREPORTTYPEID == projectSiteReport.PSRREPORTTYPEID).Select(b => b.PSRREPORTTYPEID).FirstOrDefault(),
                                    reportTypeName = context.TBL_PRODUCT.Where(p => p.PRODUCTID == a.APPROVEDPRODUCTID).Select(p => p.PRODUCTNAME).FirstOrDefault(),
        ...
        public int AddProjectSiteReport(ProjectSiteReportViewModel model)
        {
            if (model.approvalStatusId == (short)ApprovalStatusEnum.Referred)
            {
                ...
                using (var transaction = context.Database.BeginTransaction())
                {
                    ...
                    workflow.TargetId = model.projectSiteReportId;
                    workflow.Comment = TranslateHelper.get("Update has been applied, Request for Project Site Report Approval");
                    workflow.OperationId = (int)OperationsEnum.ProjectSiteReportApproval;
                    workflow.DeferredExecution = true;
                    workflow.LogActivity();
                    try
            ...
            else
            {
                ...
                this.audit.AddAuditTrail(new TBL_AUDIT
                {
                    ...
                    DETAIL = $"TBL_PSR_Project Site Report '{entity.CLIENTNAME}' {TranslateHelper.get("created by")} {auditStaff}",
        ...
        public bool ProjectSiteReportGoForApproval(ProjectSiteReportViewModel model)
        {
            var id = context.TBL_PSR_PROJECT_SITE_REPORT.Where(x=>x.PROJECTSITEREPORTID==model.projectSiteReportId && x.DELETED == false).Select(x=>x).FirstOrDefault();
                ...
                workflow.Comment = TranslateHelper.get("Request for Project Site Report approval");
                workflow.OperationId = (int)OperationsEnum.ProjectSiteReportApproval;
        ...
        public bool UpdateProjectSiteReport(ProjectSiteReportViewModel model, int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                DETAIL = $"TBL_PSR_Project Site Report '{entity.CLIENTNAME}' {TranslateHelper.get("was updated by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool DeleteProjectSiteReport(int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_PSR_Project Site Report '{entity.CLIENTNAME}' {TranslateHelper.get("was deleted by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
        ...
        public bool UpdatePsrRecommendation(PsrRecommendationViewModel model, int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_Psr Recommendation '{entity.PSRRECOMMENDATIONID}' {TranslateHelper.get("was updated by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool AddPsrRecommendation(PsrRecommendationViewModel model)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = model.createdBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"TBL_Psr Recommendation '{entity.PSRRECOMMENDATIONID}' {TranslateHelper.get("created by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool DeletePsrRecommendation(int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_Psr Recommendation '{entity.PSRRECOMMENDATIONID}' {TranslateHelper.get("was deleted by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL =user.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool UpdatePsrPerformanceEvaluation(PsrPerformanceEvaluationViewModel model, int id)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                DETAIL = $"TBL_Psr {TranslateHelper.get("Performance Evaluation")} '{entity.PSRPERFORMANCEEVALUATIONID}' {TranslateHelper.get("was updated by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool AddPsrPerformanceEvaluation(PsrPerformanceEvaluationViewModel model)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = model.createdBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Performance Evaluation")} '{entity.PSRPERFORMANCEEVALUATIONID}' {TranslateHelper.get("created by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool DeletePsrPerformanceEvaluation(int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Performance Evaluation")} '{entity.PSRPERFORMANCEEVALUATIONID}' {TranslateHelper.get("was deleted by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool UpdatePsrObservation(PsrObservationViewModel model, int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Observation")} '{entity.PSROBSERVATIONID}' {TranslateHelper.get("was updated by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool AddPsrObservation(PsrObservationViewModel model)
        {
            ...
            if (validate.Any())
            {
                throw new SecureException(TranslateHelper.get("Observation has already been captured"));
            }
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = model.createdBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Observation")} '{entity.PSROBSERVATIONID}' {TranslateHelper.get("created by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool DeletePsrObservation(int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                DETAIL = $"TBL_Psr {TranslateHelper.get("Observation was deleted by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool AddPsrNextInspectionTask(PsrNextInspectionTaskViewModel model)
        {
            ...
            if (validate.Any())
            {
                throw new SecureException(TranslateHelper.get("Next Inspection Task has already been captured"));
            }
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = model.createdBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Next Inspection Task")} '{entity.PSRNEXTINSPECTIONTASKID}' {TranslateHelper.get("created by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool DeletePsrNextInspectionTask(int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Next Inspection Task")} '{entity.PSRNEXTINSPECTIONTASKID}' {TranslateHelper.get("was deleted by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL =user.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool UpdatePsrComment(PsrCommentViewModel model, int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Comment")} '{entity.PSRCOMMENTID}' {TranslateHelper.get("was updated by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool AddPsrComment(PsrCommentViewModel model)
        {
            ...
            if (validate.Any())
            {
                throw new SecureException(TranslateHelper.get("Comment has already been captured"));
            }
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = model.createdBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Comment")} '{entity.PSRCOMMENTID}' {TranslateHelper.get("created by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool DeletePsrComment(int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Comment")} '{entity.PSRCOMMENTID}' {TranslateHelper.get("was deleted by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
      ...
      public PsrReportViewModel GeneratePSRReport(int id)
        ...
        public bool UpdatePsrPerformanceAnalysis(PsrPerformanceAnalysisViewModel model, int id)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = model.createdBy,
                BRANCHID = (short)model.BranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Performance Analysis")} '{entity.PSRANALYSISID}' {TranslateHelper.get("was updated by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool AddPsrPerformanceAnalysis(PsrPerformanceAnalysisViewModel model)
        {
            ...
            if(validate.Any())
            {
                throw new SecureException(TranslateHelper.get("Performance analysis has already been captured"));
            }
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = model.createdBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Performance Analysis")} '{entity.PSRANALYSISID}' {TranslateHelper.get("created by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
        ...
        public bool DeletePsrPerformanceAnalysis(int id, UserInfo user)
        {
            ...
            this.audit.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = user.createdBy,
                BRANCHID = (short)user.BranchId,
                DETAIL = $"TBL_Psr {TranslateHelper.get("Performance Analysis")} '{entity.PSRANALYSISID}' {TranslateHelper.get("was deleted by")} {auditStaff}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = user.applicationUrl,
                DEVICENAME = CommonHelpers.GetDeviceName(),
                OSNAME = CommonHelpers.FriendlyName(),
