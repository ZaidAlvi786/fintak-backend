    ...
    public class ContingentLoanUsageRepository : IContingentLoanUsageRepository
    {
        ...
        public bool SaveContigentLoans(ContingentLoanUsageViewModel entity)
        {
            ...
            if (context.SaveChanges() > 0)
            {
                ...
                workflow.Comment = TranslateHelper.get("APS Request approval");
        ...
        public bool SendEmailToBGDesk(int companyId, int staffId, short branchId, string facilityRefNumber)
        {
            ...
            string messageBody = TranslateHelper.get("Dear Team, <br /><br />This is to bring your attention that an APS Release has Been Initiated on ") + $" { DateTime.Today.Date }. {TranslateHelper.get("with Facility Reference Number")}" + $"{ facilityRefNumber }  <br /> <br />";

            var subject = TranslateHelper.get("APS RELEASE REQUEST");
            ...
            auditTrail.AddAuditTrail(new TBL_AUDIT
            {
                ...
                STAFFID = staffId,
                BRANCHID = branchId,
                DETAIL = TranslateHelper.get("An APS Release Email has been sent to B & G Desk"),
        ...
        private bool ApproveAPSRequest(ApproveAPSRequestViewModel entity)
        {
            ...
            if (workflow.NewState == (int)ApprovalState.Ended)
            {
                ...
                var lienModel = new CasaLienViewModel
                {
                    ...
                    companyId = entity.companyId,
                    lienAmount = oldLien,
                    description = TranslateHelper.get("Release Lien for APS Fund"),
                ...
                var lienModel2 = new CasaLienViewModel
                {
                    ...
                    description = TranslateHelper.get("Place Lien on APG Fund"),
                    lienTypeId = (short)LienTypeEnum.APSRequest,
                    createdBy = entity.createdBy,
                    userIPAddress = entity.userIPAddress,
                    applicationUrl = entity.applicationUrl,
