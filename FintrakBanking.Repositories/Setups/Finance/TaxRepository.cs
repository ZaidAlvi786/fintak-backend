    ...
    public class TaxRepository : ITaxRepository
    {
        ...
        public bool AddTax(TaxViewModel model)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Added Tax")} '{ data.TAXNAME }' ",
        ...
        public bool UpdateTax(TaxViewModel model, int taxId)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated Tax")} '{ data.TAXNAME }' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = general.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public bool DeleteTax(int taxId, UserInfo user)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Deleted Tax")} '{ data.TAXNAME }' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
