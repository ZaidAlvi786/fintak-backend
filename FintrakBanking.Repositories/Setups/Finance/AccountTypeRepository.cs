    ...
    public class AccountTypeRepository : IAccountTypeRepository
    {
        ...
        public bool AddAccountType(AddAccountTypeViewModel accounttype)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Added accounttype:")} '{accounttype.accountTypeName}' {TranslateHelper.get("with code:")} '{accounttype.accountTypeCode}' ",
        ...
        public bool UpdateAccountType(int accountTypeId, AccountTypeViewModel accounttype)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = (int)accounttype.createdBy,
                BRANCHID = (short)accounttype.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated accounttype:")} '{accounttype.accountTypeName}' {TranslateHelper.get("with code:")} '{accounttype.accountTypeCode}' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = accounttype.applicationUrl,
                APPLICATIONDATE = genSetup.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public bool DeleteAcountType(int accountTypeId, UserInfo user)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Deleted accounttype:")} '{type.ACCOUNTTYPENAME}' {TranslateHelper.get("with code:")} '{type.ACCOUNTTYPECODE}' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
