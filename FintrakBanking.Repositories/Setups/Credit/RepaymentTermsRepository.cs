        ...
        public bool AddRepaymentTerm(RepaymentScheduleTermSetupViewModel model)
        {
            ...
            auditTrail.AddAuditTrail(
                new TBL_AUDIT
                {
                    ...
                    DETAIL = $"{TranslateHelper.get("TBL_REPAYMENT_TERM with")} {model.ToString()} {TranslateHelper.get("is added")}",
        ...
        public bool DeleteRepaymentTerm(int id, UserInfo user)
        {
            ...
            auditTrail.AddAuditTrail(
                new TBL_AUDIT
                {
                    ...
                    DETAIL = $"{TranslateHelper.get("TBL_REPAYMENT_TERM with")} {term.ToString()} {TranslateHelper.get("is deleted")}",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
