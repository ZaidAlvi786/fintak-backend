...
namespace FintrakBanking.Interfaces.Setups.Credit
{
    public class CollateralTypeRepository : ICollateralTypeRepository
    {
        ...
        public async Task<IEnumerable<CollateralTypeViewModel>> CollateralTypesByLoanApplication(int? applicationId)
        {
            ...
            var list = await context.TBL_COLLATERAL_TYPE
                       .Select(m => new CollateralTypeViewModel
                       {
                           collateralTypeId = m.COLLATERALTYPEID,
                           collateralTypeName = m.COLLATERALTYPENAME,
        ...
        public async Task<IEnumerable<CollateralDocumentTypeViewModel>> GetCollateralDocumentTypes(int id)
        {
            //var documentType = context.TBL_COLLATERAL_DOCUMENT_TYPE.Where(x => x.COLLATERALTYPEID == id).ToList();

            var documentType = await (from m in context.TBL_COLLATERAL_DOCUMENT_TYPE
        ...
        public async Task<bool> AddCollateralDocumentType(CollateralDocumentTypeViewModel entity)
        {
            bool output = false;
            ...
            if(entity.documentTypeId==0)
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    DETAIL = $"{TranslateHelper.get("Added collateral Document Type:")} { entity.documentType  }  {TranslateHelper.get("Created for")} {collateralType.COLLATERALTYPENAME} ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    APPLICATIONDATE =  appDate.Date,
            ...
            else
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = entity.createdBy,
                    BRANCHID = entity.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Updated collateral Document Type:")} { entity.documentType  }  {TranslateHelper.get("Created for")} {collateralType.COLLATERALTYPENAME} ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    APPLICATIONDATE = appDate.Date,
                    SYSTEMDATETIME = DateTime.Now.Date,
                    URL = entity.applicationUrl,
        ...
        {
            var collateralTypes = CollateralTypes();
        ...
        public async Task<bool> UpdateCollateralTypes(int typeId, CollateralTypeViewModel entity)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Updated Collateral Type:")} { entity.collateralTypeName } ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = entity.applicationUrl,
        ...
        private async Task<IEnumerable<CollateralSubTypeViewModel>> CollateralSubType()
        {
            return await (from m in context.TBL_COLLATERAL_TYPE_SUB
        ...
        public async Task<CollateralSubTypeViewModel> CollateralSubType(int Id)
        {
            return await (from m in context.TBL_COLLATERAL_TYPE_SUB
        ...
        public async Task<IEnumerable<CollateralSubTypeViewModel>> GetCollateralSubTypes()
        {
            return await(from m in context.TBL_COLLATERAL_TYPE_SUB
        ...
        public async Task<IEnumerable<CollateralSubTypeViewModel>> GetCollateralSubTypeByCollateralTypeId(short collateralTypeId)
        {
            var collateralTypes = await CollateralSubType();
            return collateralTypes.Where(x => x.collateralTypeId == collateralTypeId);
        }
        ...
        public async Task<bool> UpdateCollateralSubTypes(int subTypeId, CollateralSubTypeViewModel entity)
        {
            ...
            subType.DATETIMEUPDATED = appDate.  Date;
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = entity.createdBy,
                BRANCHID = (short)entity.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated Collateral Type:")} { entity.collateralSubTypeName } ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = entity.applicationUrl,
                APPLICATIONDATE = appDate.Date,
                SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<bool> DeleteCollateralSubTypes(int subTypeId, CollateralSubTypeViewModel entity, UserInfo user)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Deleted Collateral Sub Type:")} { entity.collateralSubTypeName } ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
        ...
        public async Task<bool> AddCollateralSubTypes(CollateralSubTypeViewModel entity)
        {
            ...
            var type = new TBL_COLLATERAL_TYPE_SUB
            {
                ...
                VISITATIONCYCLE = entity.visitationCycle
            };
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = entity.createdBy,
                BRANCHID = (short)entity.userBranchId,
                DETAIL = $"{TranslateHelper.get("Added Collateral Type sub:")} { entity.collateralSubTypeName } ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = entity.applicationUrl,
                APPLICATIONDATE =appDate.Date,
                SYSTEMDATETIME = DateTime.Now,
