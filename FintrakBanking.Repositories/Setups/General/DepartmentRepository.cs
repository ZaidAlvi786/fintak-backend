...
namespace FintrakBanking.Repositories.Setups.General
{
    public class DepartmentRepository : IDepartmentRepository
    {
        ...
        /// <returns></returns>
        public async Task<bool> AddDepartment(DepartmentViewModel entity)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = TranslateHelper.get("Added new department"),
        ...
        /// <param name="entity">The entity.</param>
        /// <returns></returns>
        public async Task<bool> AddUnit(DepartmentViewModel entity)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = entity.createdBy,
                BRANCHID = (short)entity.userBranchId,
                DETAIL = $"{TranslateHelper.get("Added new department unit")} {entity.unitName} {TranslateHelper.get("to")} {departmentName} {TranslateHelper.get("department")}",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = entity.applicationUrl,
                APPLICATIONDATE = _genSetup.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        /// <param name="entity">The entity.</param>
        /// <returns></returns>
        public async Task<bool> UpdateUnit(short unitId, DepartmentViewModel entity)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = entity.createdBy,
                BRANCHID = (short)entity.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated department unit with Id:")} {unitId} ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = entity.applicationUrl,
                APPLICATIONDATE = _genSetup.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        /// <returns></returns>
        /// 
        public async Task<bool> DeleteUnit(UserInfo user, int unitId)
        {
           ...
           // return SaveAll();
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("deleted department unit with Id:")} {unitId} ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
        ...
        /// <param name="entity">The entity.</param>
        /// <returns></returns>
        public async Task<bool> UpdateDepartment(int departmentId, DepartmentViewModel entity)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = entity.createdBy,
                BRANCHID = (short)entity.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated department with Id:")} {entity.departmentId} ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = entity.applicationUrl,
                APPLICATIONDATE = _genSetup.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
