...
namespace FintrakBanking.Repositories.Setups.General
{
    ...
    public class BranchRepository : IBranchRepository
    {
        ...
        //}
        #region Region Setup
        public async Task<IEnumerable<BranchRegionViewModel>> GetAllRegion()
        {
            var regions = await context.TBL_BRANCH_REGION.Where(x => x.DELETED == false).Select(x => new BranchRegionViewModel
            {
                regionId = x.REGIONID,
        ...
        public async Task<IEnumerable<BranchRegionStaffViewModel>> GetAllRegionStaff(int regionId)
        {
            var regions = await context.TBL_BRANCH_REGION_STAFF.Where(x => x.DELETED == false && x.REGIONID == regionId).Select(x => new BranchRegionStaffViewModel
            {
        ...
        public async Task<IEnumerable<LookupViewModel>> GetAllRegionStaffType()
        {
            var regions = await context.TBL_BRANCH_REGION_STAFF_TYPE.Select(x => new LookupViewModel
            {
        ...
        public async Task<bool> ValidateRegionName(string regionName)
        {
            return await context.TBL_BRANCH_REGION.Where(x => x.REGION_NAME == regionName).AnyAsync();
        }
        #endregion
        ...
        public async Task<IEnumerable<BranchViewModel>> GetAllBranch()
        {
            var branches = await (from x in context.TBL_BRANCH
        ...
        public async Task<IEnumerable<CollectionsRetailCronSetupViewModel>> GetCollectionRetailCronJobSetup()
        {
            var retailCollection = await (from x in context.TBL_COLLECTION_RETAIL_CRON_SETUP
                                   where x.DELETED == false
            ...
            return retailCollection;
        }

        public async Task<IEnumerable<CollectionsRetailComputationVariableSetupViewModel>> GetCollectionRetailComputationVariablesSetup()
        {
            var retailCollection = await (from x in context.TBL_COLLECTION_COMPUTATION_VARIABLES_SETUP
                                   where x.DELETED == false
