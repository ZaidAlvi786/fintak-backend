...
namespace FintrakBanking.Repositories.Setups.General
{
    public class CompanyRepository : ICompanyRepository
    {
        ...
        {
            var languages =  await(from data in context.TBL_LANGUAGE
        ...
        public async Task<IEnumerable<CompanyDirectorsViewModel>> GetCompanyDirectors()
        {
            var directors = await (from data in context.TBL_COMPANY_DIRECTOR
        ...
        public async Task<IEnumerable<LookupViewModel>> GetCompanyDirectorsByCompanyId(int companyId)
        {
            var directors = await (from data in context.TBL_COMPANY_DIRECTOR
        ...
        public async Task<IEnumerable<CompanyDirectorsViewModel>> GetCustomerCompanyDirectorsByCompanyId(int companyId)
        {
            var directors = await (from data in context.TBL_COMPANY_DIRECTOR
                             where data.COMPANYID == companyId && data.DELETED == false
                             select new CompanyDirectorsViewModel()
