...
namespace FintrakBanking.Repositories.Setups.General
{
    ...
    public class ProductRepository : IProductRepository
    {
        ...
        public async Task<IEnumerable<LookupViewModel>> GetProductClassByProcessId(int processId)
        {
            return  await (from data in context.TBL_PRODUCT_CLASS.Where(c => c.PRODUCT_CLASS_PROCESSID == processId)
                        //where data.OperationTypeId == operationTypeId
                    select new LookupViewModel()
                    {
                        lookupId = (short)data.PRODUCTCLASSID,
        ...
        public async Task<ProductBehaviourViewModel> GetProductBehaviour(int productId)
            {
                ProductBehaviourViewModel data;
                data = await context.TBL_PRODUCT_BEHAVIOUR.Where(p => p.PRODUCTID == productId).Select(p => new ProductBehaviourViewModel
                {
            ...
            public async Task<IEnumerable<LookupViewModel>> GetProductCurrency(int productId)
            {
                var data =  await (from p in context.TBL_PRODUCT_CURRENCY
            ...
            public bool AddProductGroup(ProductGroupViewModel productGroupModel)
            {
                ...
                {
                    throw new SecureException(TranslateHelper.get("Product group already exists!"));
                }
                ...
                {
                    throw new SecureException(TranslateHelper.get("Product group with that code already exists!"));
                }
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    DETAIL = $"{TranslateHelper.get("Added product Group:")} '{productGroupModel.productGroupName}' ",
            ...
            public bool UpdateProductGroup(int productGroupId, ProductGroupViewModel productGroup)
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    DETAIL = $"{TranslateHelper.get("Updated tbl_Product Group:")} '{productGroup.productGroupName}' {TranslateHelper.get("with code:")} '{productGroup.productGroupCode}' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
            ...
            public bool DeleteProductGroup(int productGroupId, UserInfo user)
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    DETAIL = $"{TranslateHelper.get("Deleted Product Group:")} '{productPriceIndex?.PRODUCTGROUPNAME}' {TranslateHelper.get("with code")} '{productPriceIndex?.PRODUCTGROUPCODE}' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
            ...
            public short AddProductType(ProductTypeViewModel productType)
            {
                ...
                {
                    throw new SecureException(TranslateHelper.get("Product type already exists!"));
                }
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    DETAIL = $"{TranslateHelper.get("Added tbl_Product Type:")} '{productType.productTypeName}' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
            ...
            public bool UpdateProductType(int productTypeId, ProductTypeViewModel productType)
            {
                ...
                if (data.PRODUCTGROUPID != productType.productGroupId)
                {
                    ...
                    {
                        throw new SecureException(TranslateHelper.get("The product group for this product type cannot be changed because the product type is already in use"));
                    }
                }
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = productType.createdBy,
                    BRANCHID = (short)productType.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Updated tbl_Product Type:")} '{productType.productTypeName}' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = productType.applicationUrl,
                    APPLICATIONDATE = genSetup.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
            ...
            public bool DeleteProductType(int productTypeId, UserInfo user)
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = user.staffId,
                    BRANCHID = (short)user.BranchId,
                    DETAIL = $"{TranslateHelper.get("Deleted Product Type:")} '{data.PRODUCTTYPENAME}' {TranslateHelper.get("under group")} '{data.TBL_PRODUCT_GROUP.PRODUCTGROUPNAME}' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = user.applicationUrl,
                    APPLICATIONDATE = genSetup.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<IEnumerable<ProductLiteViewModel>> GetAllProductLite()
            {
            ...
            public async Task<IEnumerable<ProductViewModel>> GetAllProductByProductClass(int productClassId, int customerTypeId)
            {
                if (customerTypeId == 0)
                {
                    customerTypeId = 2;
                ...
                foreach (var item in product)
                {
                    var ProductBehaviour = await context.TBL_PRODUCT_BEHAVIOUR.Where(d => d.PRODUCTID == item.productId).Select(d => new ProductBehaviourViewModel()
                    {
                        customerLimit = d.CUSTOMER_LIMIT,
                        collateralFcyLimit = d.COLLATERAL_FCY_LIMIT ?? 0,
                        collateralLcyLimit = d.COLLATERAL_LCY_LIMIT ?? 0,
                    ...
                    var currencies = await context.TBL_PRODUCT_CURRENCY.Where(curr => curr.PRODUCTID == item.productId && curr.DELETED != false)
                                    .Select(c => new ProductCurrencyViewModel()
                                    {
                                        productId = c.PRODUCTID,
                                        productCurrencyId = c.PRODUCTCURRENCYID,
            ...
            public async Task<IEnumerable<ProductViewModel>> GetAllProductsByProductClassIdAndCustomerTypeId(int productClassId, int customerTypeId)
            {
            ...
            public async Task<IEnumerable<LookupViewModel>> GetAllCRMSType(int companyId)
            {
                return await context.TBL_CRMS_REGULATORY.Where(x => x.CRMSTYPEID == (int)RegulatoryTypeEnum.LoanType && x.COMPANYID == companyId).Select(x => new LookupViewModel()
                {
                    lookupId = (short)x.CRMSREGULATORYID,
                    lookupName = x.CODE + "-" + x.DESCRIPTION
                }).ToListAsync();
            }
            public async Task<IEnumerable<LookupViewModel>> GetAllRiskRatingType(int companyId)
            {
                return await context.TBL_CUSTOMER_RISK_RATING.Where(x => x.COMPANYID == companyId).Select(x => new LookupViewModel()
                {
                    lookupId = (short)x.RISKRATINGID,
                    lookupName = x.RISKRATING
                }).ToListAsync();
            }
            public async Task<ProductViewModel> GetTempProductDetail(int productId)
            {
                //return GetTempStaffDetails().Where(x => x.StaffId == staffId).Single();

                var productData = await (from tp in context.TBL_TEMP_PRODUCT
                ...
                var currencies = await context.TBL_TEMP_PRODUCT_CURRENCY.Where(curr => curr.TEMP_PRODUCTID == productData.productId && curr.DELETED != false).Select(pc => new ProductCurrencyViewModel()
                {
                    productId = pc.TEMP_PRODUCTID,
                    productCurrencyId = pc.PRODUCTCURRENCYID,
                    currencyId = pc.CURRENCYID,
                ...
                var fees = await context.TBL_TEMP_PRODUCT_CHARGE_FEE.Where(curr => curr.TEMP_PRODUCTID == productData.productId && curr.DELETED != false).Select(pf => new ProductFeeViewModel()
                {
                    productId = pf.TEMP_PRODUCTID,
                    productFeeId = pf.PRODUCTFEEID,
                    feeId = pf.CHARGEFEEID,
                ...
                using (var trans = context.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        if (workFlow.NewState == (int)ApprovalState.Ended)
                        {
                            ...
                            else throw new ConditionNotMetException(TranslateHelper.get("One or more errors occured on commit."));
                            return 1;
                        }
                        else
                        {
            ...
            public async Task<ProductViewModel> AddTempProduct(ProductViewModel productModel)
            {
                ...
                if (isPrincipalGLRequired)
                {
                    if (productModel.currencies == null)
                        throw new SecureException(TranslateHelper.get("Product Currency must be specified. Please select a principal GL with mapped currencies"));
                }
            ...
            if (isProductCodeExist)
            {
                throw new SecureException(TranslateHelper.get("Product code already exist"));
            }
            ...
            bool output = false;
                ...
                if (existingTempProduct != null)
                {
                    throw new SecureException(TranslateHelper.get("Product Information already exist and is undergoing approval"));
                }
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    DETAIL = $"{TranslateHelper.get("Initiated Product Creation for")} '{productModel.productName}' {TranslateHelper.get("with code")} '{productModel.productCode}'",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                ...
                using (var trans = context.Database.BeginTransaction())
                {
                    try
                    {
                        ...
                        var entity = new ApprovalViewModel
                        {
                            ...
                            comment = TranslateHelper.get("Please approve this product"),
            ...
            try
            {
                ...
                {
                    throw new SecureException(TranslateHelper.get("Product is already undergoing approval"));
                }
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = productModel.createdBy,
                    BRANCHID = (short)productModel.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Updated Product")} '{productModel.productName}' {TranslateHelper.get("with code")} '{productModel.productCode}'",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = productModel.applicationUrl,
                    APPLICATIONDATE = genSetup.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<ProductPriceIndexViewModel> GetAllProductPriceIndicesById(int priceIndexId)
        {
            return await (from data in context.TBL_PRODUCT_PRICE_INDEX
        ...
        private IEnumerable<ProductPriceIndexGlobalViewModel> GetProductPriceIndexGlobalApprovalList(int staffId)
            ...
            public async Task<ProductPriceIndexViewModel> GetProductPriceIndexByProductId(int productId)
            {
                var data = await (from b in context.TBL_PRODUCT
            ...
            public WorkflowResponse AddProductPriceIndexGlobal(ProductPriceIndexGlobalViewModel prodPriceIndexGlobal)
            {
                ...
                {
                    throw new ConditionNotMetException(TranslateHelper.get("Effective Date Can Not be More than Application Date."));
                }
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    DETAIL = $"{TranslateHelper.get("Added Price Index Global:")} '{prodPriceIndexGlobal.productPriceIndexGlobalId}' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
        ...
        public bool UpdateProductPriceIndexGlobal(int productPriceIndexGlobalId, ProductPriceIndexGlobalViewModel prodPriceIndexGlobal)
        {
            ...
            if (globalInterest == null)
                throw new SecureException(TranslateHelper.get("Record is Undergoing Approval"));
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = (int)prodPriceIndexGlobal.createdBy,
                BRANCHID = (short)prodPriceIndexGlobal.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated Price Index Global:")} '{prodPriceIndexGlobal.productPriceIndexGlobalId}' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = prodPriceIndexGlobal.applicationUrl,
                APPLICATIONDATE = genSetup.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
            ...
            public ProductPriceIndexViewModel AddProductPriceIndex(ProductPriceIndexViewModel prodPriceIndex)
            {
                ...
                if(prodPriceIndex.priceIndexRate > 100)
            {
                throw new ConditionNotMetException(TranslateHelper.get("Rate cannot be more than 100%"));
            }
            if (prodPriceIndex.priceIndexDuration > 365)
            {
                throw new ConditionNotMetException(TranslateHelper.get("Duration cannot be more than 365 Days"));
            }
            ...
            var audit = new TBL_AUDIT
                {
                    ...
                    DETAIL = $"{TranslateHelper.get("Added tbl_Product Price Index:")} '{prodPriceIndex.priceIndexName}' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
            ...
            public bool UpdateProductPriceIndex(int productPriceIndexId, ProductPriceIndexViewModel prodPriceIndex)
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = (int)prodPriceIndex.createdBy,
                    BRANCHID = (short)prodPriceIndex.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Updated tbl_Product Price Index:")} '{prodPriceIndex.priceIndexName}' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = prodPriceIndex.applicationUrl,
                    APPLICATIONDATE = genSetup.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
            ...
            public bool DeleteProductPriceIndex(int productPriceIndexId, UserInfo user)
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = user.staffId,
                    BRANCHID = (short)user.BranchId,
                    DETAIL = $"{TranslateHelper.get("Deleted tbl_Product Price Index:")} '{data.PRICEINDEXNAME}' {TranslateHelper.get("with rate")} '{data.PRICEINDEXRATE}' ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = user.applicationUrl,
                    APPLICATIONDATE = genSetup.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
            ...
            public async Task<IEnumerable<ProductClassProcessViewModel>> GetAllProductClassProcesses()
            {
                var data = await (from p in context.TBL_PRODUCT_CLASS_PROCESS
        ...
        public async Task<IEnumerable<ProductClassificationViewModel>> GetAllProductClassification()
        {
            var data = await (from p in context.TBL_PRODUCT_CLASS
                ...
                if (model != null)
                {
                    ...
                    context.TBL_PRODUCT_CLASS.Add(productClass);
                        ...
                        var audit = new TBL_AUDIT
                        {
                            ...
                            DETAIL = $"{TranslateHelper.get("Added/Updated Product Classification with name:")} '{model.productClassName}' ",
                            IPADDRESS = CommonHelpers.GetLocalIpAddress(),
        ...
        public async Task<IEnumerable<ProductDocumentMappingViewModel>> GetAllProductDocumentMapping()
        {
            var products = context.TBL_PRODUCT.Where(p => p.DELETED == false).ToList();
            var productClasses = context.TBL_PRODUCT_CLASS.ToList();

            var mappings = await (from p in docContext.TBL_DOC_MAPPING
                            where p.DELETED == false
        ...
        public bool AddProductDocumentMapping(ProductDocumentMappingViewModel model)
        {
            ...
            {
                throw new SecureException(TranslateHelper.get("Please select an item to map to!"));
            }
            ...
            var audit = new TBL_AUDIT
            {
                ...
                STAFFID = (int)model.createdBy,
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"{TranslateHelper.get("Added : TBL_PRODUCT_DOCUMENT_MAPPING")}'{model.productId}' ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = genSetup.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<ProductDocumentMappingViewModel> GetProductDocumenetMapping(int Id)
        {
            var entity = await docContext.TBL_DOC_MAPPING.Where(x => x.DELETED == false && x.PRODUCTDOCMAPID == Id)
    ...
    public bool AddDocumentDefinition(DocumentDefinitionViewModel model)
    {
        ...
        var audit = new TBL_AUDIT
        {
            ...
            STAFFID = (int)model.createdBy,
            BRANCHID = (short)model.userBranchId,
            DETAIL = $"{TranslateHelper.get("Added new document definition")} '{model.documentDefinitionId}' ",
            IPADDRESS = CommonHelpers.GetLocalIpAddress(),
            URL = model.applicationUrl,
            APPLICATIONDATE = genSetup.GetApplicationDate(),
            SYSTEMDATETIME = DateTime.Now,
