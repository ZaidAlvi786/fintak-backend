    ...
    public class CustomFieldsRepository : ICustomFieldsRepository
    {
        ...
        public async Task<bool> AddCustomField(AddCustomFieldViewModel model)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                DETAIL = $"{TranslateHelper.get("Added the following custom field :")} { model.labelName} {TranslateHelper.get("to")}  {context.TBL_CUSTOM_HOSTPAGE.Find(model.hostPageId).HOSTPAGE } {TranslateHelper.get("form")} ",
        ...
        public async Task<bool> UpdateCustomField(AddCustomFieldViewModel model, int id)
        {
            ...
            var audit = new TBL_AUDIT
            {
                ...
                BRANCHID = (short)model.userBranchId,
                DETAIL = $"{TranslateHelper.get("Updated the following custom field :")} { model.labelName} {TranslateHelper.get("to")}  {context.TBL_CUSTOM_HOSTPAGE.Find(model.hostPageId).HOSTPAGE } {TranslateHelper.get("form")} ",
                IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                URL = model.applicationUrl,
                APPLICATIONDATE = genSetup.GetApplicationDate(),
                SYSTEMDATETIME = DateTime.Now,
        ...
        public async Task<bool> DeleteCustomFields(List<CustomFieldViewModel> customFields, UserInfo user)
        {
            ...
            for (int i = 0; customFields.Count > i; i++)
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    DETAIL = $"{TranslateHelper.get("Deleted the following custom field :")} { custom.LABELNAME} {TranslateHelper.get("to")}  {context.TBL_CUSTOM_HOSTPAGE.Find(custom.HOSTPAGEID).HOSTPAGE } {TranslateHelper.get("form")} ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
        ...
        public async Task<bool> UpdateCustomFields(List<CustomFieldViewModel> listEntity)
        {
            ...
            foreach (var entity in listEntity)
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    BRANCHID = (short)entity.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Updated the following custom field :")} { entity.labelName} {TranslateHelper.get("to")}  {context.TBL_CUSTOM_HOSTPAGE.Find(entity.hostPageId).HOSTPAGE } {TranslateHelper.get("form")} ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = entity.applicationUrl,
                    APPLICATIONDATE = genSetup.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
            ...
            public async Task<bool> AddCustomFieldsData(List<CustomFieldsDataViewModel> listEntity)
        {
            foreach (var entity in listEntity)
            {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = entity.createdBy,
                    BRANCHID = (short)entity.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Added the following custom field :")} { entity.labelName} {TranslateHelper.get("to")}  {context.TBL_CUSTOM_HOSTPAGE.Find(entity.hostPageId).HOSTPAGE } {TranslateHelper.get("form")} ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = entity.applicationUrl,
                    APPLICATIONDATE = genSetup.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
        ...
        public async  Task<bool> DeleteCustomFieldsData(List<CustomFieldsDataViewModel> listEntity, UserInfo user)
        {
            foreach (var entity in listEntity) {
                ...
                var audit = new TBL_AUDIT
                {
                    ...
                    STAFFID = entity.createdBy,
                    BRANCHID = (short)entity.userBranchId,
                    DETAIL = $"{TranslateHelper.get("Deleted a custom field data for :")} { entity.labelName} {TranslateHelper.get("from")}  {context.TBL_CUSTOM_HOSTPAGE.Find(entity.hostPageId).HOSTPAGE }  ",
                    IPADDRESS = CommonHelpers.GetLocalIpAddress(),
                    URL = entity.applicationUrl,
                    APPLICATIONDATE = genSetup.GetApplicationDate(),
                    SYSTEMDATETIME = DateTime.Now,
