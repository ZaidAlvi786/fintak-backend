...
namespace FintrakBanking.Repositories.CASA
{
    public class CasaRepository : ICasaRepository
    {
        ...
        public async Task<string> GetCustomerAccountNumber(int casaAccountId)
        {
        ...
        public async Task<string> GetAccountOwnerByAccountNumber(string accountNumber, int companyId)
        {
            var custName = await (from data in context.TBL_CASA
        ...
        public async Task<string> GetAllCASAAccount(string casaAccountNumber, int companyId)
        {
            string accno = "";
        ...
        public async Task<IEnumerable<CasaAccountLienViewModel>> GetAllCasaLiens(string accountNumber)
        {
            var result = await context.TBL_CASA_LIEN.Where(O => O.PRODUCTACCOUNTNUMBER == accountNumber && O.ISLIENREMOVED == false).Select(O => new CasaAccountLienViewModel()
            {
                lienId = O.LIENID,
        ...
        public async Task<IEnumerable<CasaLienTypeViewModel>> GetAllCasaLienTypes(int companyId)
        {
            var result = await context.TBL_CASA_LIEN_TYPE.Select(O => new CasaLienTypeViewModel()
            {
                lienTypeId = O.LIENTYPEID,
        ...
        public async Task<IEnumerable<CasaLoanViewModel>> GetAllCasaLoans(int companyId, int casaAccountId)
        {
            var result = await context.TBL_LOAN.Where(O => O.CASAACCOUNTID == casaAccountId && O.LOANSTATUSID != (int) LoanStatusEnum.Cancelled && O.LOANSTATUSID != (int)LoanStatusEnum.Terminated && O.LOANSTATUSID != (int)LoanStatusEnum.Completed).Select(O => new CasaLoanViewModel()
            {
                loanId = O.TERMLOANID,
                loanReferenceNumber = O.LOANREFERENCENUMBER
            }).ToListAsync();

            var result1 = await context.TBL_LOAN_CONTINGENT.Where(O => O.CASAACCOUNTID == casaAccountId && O.LOANSTATUSID != (int)LoanStatusEnum.Cancelled && O.LOANSTATUSID != (int)LoanStatusEnum.Terminated && O.LOANSTATUSID != (int)LoanStatusEnum.Completed).Select(O => new CasaLoanViewModel()
            {
                loanId = O.CONTINGENTLOANID,
                loanReferenceNumber = O.LOANREFERENCENUMBER
            }).ToListAsync();

            var result2 = await context.TBL_LOAN_REVOLVING.Where(O => O.CASAACCOUNTID == casaAccountId && O.LOANSTATUSID != (int)LoanStatusEnum.Cancelled && O.LOANSTATUSID != (int)LoanStatusEnum.Terminated && O.LOANSTATUSID != (int)LoanStatusEnum.Completed).Select(O => new CasaLoanViewModel()
            {
        ...
        public async Task<bool> AddCasaLien(CasaViewModel model)
        {
        ...
        public async Task<IEnumerable<CasaViewModel>> FindCustomerCasaLien(string accountNumberOrName, int companyId)
        {
        ...
        public async Task<IEnumerable<CasaViewModel>> FindAccount(string accountNumberOrName, int companyId)
        {
        ...
        public async Task<IEnumerable<CasaViewModel>> GetGroupAccountNumberWithCustomerId(string accountNumberOrName, int customerId, int companyId)
        {
        ...
        public async Task<IEnumerable<CasaViewModel>> GetOverdraftAccountNumberWithCustomerId(string accountNumberOrName, int customerId, int companyId)
        {
            ...
            {
                result = await (from data in context.TBL_CASA
                          join cust in context.TBL_CUSTOMER on data.CUSTOMERID equals cust.CUSTOMERID
                          join custGroup in context.TBL_CUSTOMER_GROUP_MAPPING on cust.CUSTOMERID equals custGroup.CUSTOMERID
        ...
        public async Task<CasaViewModel>  GetAccount(int casaAccountId)
        {
            return await (from data in context.TBL_CASA
        ...
        public async Task<IEnumerable<CustomerCasaAcountsViewModel>> GetAllCustomerAccount(int customerId, int applicationTypeId, int companyId)
        {
        ...
        public async Task<IEnumerable<CasaViewModel>> GetAccountByCustomerId(int customerId)
        {
            return (from data in context.TBL_CASA
        ...
        public async Task<CasaCustomerSearchViewModel> GetCustomerAccountDetailsById(int customerId)
        {
            var data =  await (from casa in context.TBL_CASA
                        join cust in context.TBL_CUSTOMER on casa.CUSTOMERID equals cust.CUSTOMERID
                        join sector in context.TBL_SUB_SECTOR on cust.SUBSECTORID equals sector.SUBSECTORID
                        join custGroup in context.TBL_CUSTOMER_GROUP_MAPPING on cust.CUSTOMERID equals custGroup.CUSTOMERID into cGroup
                        from custGroup in cGroup.DefaultIfEmpty()
            ...
            if(data.Count() <= 0)
            {
                data = await (from casa in context.TBL_CASA
                         join cust in context.TBL_CUSTOMER on casa.CUSTOMERID equals cust.CUSTOMERID
                         join sector in context.TBL_SUB_SECTOR on cust.SUBSECTORID equals sector.SUBSECTORID
            ...
            if (data.Count() <= 0)
            {
                data = await (from cust in context.TBL_CUSTOMER
                            //join prod in context.tbl_Product on casa.ProductId equals prod.ProductId
                        join sector in context.TBL_SUB_SECTOR on cust.SUBSECTORID equals sector.SUBSECTORID
                        join custGroup in context.TBL_CUSTOMER on cust.CUSTOMERID equals custGroup.CUSTOMERID into cGroup
                        from custGroup in cGroup.DefaultIfEmpty()
        ...
        public async Task<IEnumerable<CasaBalanceViewModel>> GetAllCustomerAccountByCustomerIdAndCurrency(int customerId, int companyId, int currencyId)
        {
            var data = await (from a in context.TBL_CASA
        ...
        public async Task<IEnumerable<CasaBalanceViewModel>> GetAllCustomerAccountByCustomerId(int customerId, int companyId)
        {
            var data = await (from a in context.TBL_CASA
                        where a.CUSTOMERID == customerId && a.COMPANYID == companyId  //orderby account.AccountCode ascending, account.AccountName ascending
                        select new CasaBalanceViewModel
        ...
        public async Task<IEnumerable<CasaBalanceViewModel>> GetBusinessAccounts( int companyId)
        {
            var data = await (from a in context.TBL_CASA
