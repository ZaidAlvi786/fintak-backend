...

{
    public class CreditLimitValidationsRepository : ICreditLimitValidationsRepository
    {
        ...
        public async Task<int> ValidateWatchList(int customerId)
        {
        ...
        public async Task<IEnumerable<CustomerEligibilityViewModel>> ValidateCustomerEligibility(string customerCode)
        {
            var customerEligibility = await (from a in context.TBL_LOAN_CAMSOL
        ...
        public async Task<CustomerEligibility> GetCustomerEligibility(string customerCode)
        {
            var camsol = await (from a in context.TBL_LOAN_CAMSOL
                                join b in context.TBL_LOAN_CAMSOL_TYPE on a.CAMSOLTYPEID equals b.CAMSOLTYPEID
                                where a.CUSTOMERCODE == customerCode && a.CANTAKELOAN == false
                                select new { b.CAMSOLTYPENAME }).FirstOrDefaultAsync();
            ...
            if (camsol != null)
            {
                ...
                result.message = TranslateHelper.get("This customer is in ") + camsol.CAMSOLTYPENAME;
            }

            return result;
        }

        public async Task<int> ValidateBlackList(string customerCode)
        {
        ...
        public async Task<CreditLimitValidationsModel> ValidateAmountByBranch(short branchId)
        {

            CreditLimitValidationsModel model = new CreditLimitValidationsModel();
            var outstandingbal = await (from d in context.TBL_LOAN
                                        where d.BRANCHID == branchId && d.LOANSTATUSID == (short)LoanStatusEnum.Active
                                        select d.OUTSTANDINGPRINCIPAL).SumAsync();
        ...
        public async Task<CreditLimitValidationsModel> ValidateAmountBySegment(short segmentId)
        {
        ...
        public async Task<CreditLimitValidationsModel> ValidateNPLBySegment(short segmentId)
        {
        ...
        public async Task<CreditLimitValidationsModel> ValidateAmountBySector(int subSectorId)
        {
            ...
            if (countryCode == "ZMW" || countryCode == "GHS" )
            {
                totalExposure = context.TBL_SECTOR_GLOBAL_LIMIT.Where(g => g.CBNSECTORID == sector.CODE)?.Select(g => g.TOTALEXPOSURELCY).FirstOrDefault();
                sectorLimit = context.TBL_SECTOR_GLOBAL_LIMIT.Where(g => g.CBNSECTORID == sector.CODE)?.Select(g => g.THRESHOLDLIMIT).FirstOrDefault();
                exposureLimit = context.TBL_SECTOR_GLOBAL_LIMIT.Where(g => g.CBNSECTORID == sector.CODE)?.Select(g => g.EXPOSURES).FirstOrDefault();
            }
        ...
        public async Task<CreditLimitValidationsModel> ValidateAmountBySectorOld(int subSectorId)
        {
            CreditLimitValidationsModel model = new CreditLimitValidationsModel();
            ...
            var outstandingbal = await (from a in context.TBL_LOAN
                                        ...
                                        select a.OUTSTANDINGPRINCIPAL).SumAsync();
        ...
        public CreditLimitValidationsModel ValidateNPLBySector(int subSectorId)
        {
            ...
            if (countryCode == "ZMW" || countryCode == "GHS")
            {
                ...
                sectorLimit = context.TBL_SECTOR_GLOBAL_LIMIT.Where(s => s.CBNSECTORID.Trim() == sector.CODE.Trim())?.Select(s => s.THRESHOLDLIMIT).FirstOrDefault();
        ...
        public async Task<IEnumerable<SectorLimitViewModel>> GetSectorLoanAmountLimit()
        {
            CreditLimitValidationsModel model = new CreditLimitValidationsModel();
        ...
        public async Task<CreditLimitValidationsModel> ValidateAmountByCustomer(int customerId)
        {
            CreditLimitValidationsModel model = new CreditLimitValidationsModel();
        ...
        public async Task<CreditLimitValidationsModel> ValidateNPLByCustomer(int customerId)
        {
            CreditLimitValidationsModel model = new CreditLimitValidationsModel();
            var outstandingbal = from d in context.TBL_LOAN
        ...
        public List<CurrentCustomerExposure> GetGlobalCustomerExposureByCurrency()
        {
            try
            {
                ...
                exposures = (from a in context.TBL_GLOBAL_EXPOSURE
                             where a.ALPHA_CODE.ToUpper().Trim() != "NGN"
                             select new CurrentCustomerExposure
                             {
                                 facilityType = a.ADJFACILITYTYPE,
                                 existingLimit = a.PRINCIPALOUTSTANDINGBALLCY ?? 0,
        ...
        public CreditLimitValidationsModel ValidateSingleObligorLimit(LoanApplicationViewModel application)
        {
            ...
            {
                throw new SecureException(TranslateHelper.get("Single Obligor Limit has not been setup for") + company.NAME + " !");
            }
        ...
        public async Task<CreditLimitValidationsModel> ValidateAmountByCustomerGroup(int customergroupId)
        {
            CreditLimitValidationsModel model = new CreditLimitValidationsModel();
            var outstandingbal = from d in context.TBL_LOAN
        ...
        public async Task<CreditLimitValidationsModel> ValidateNPLByCustomerGroup(int customergroupId)
        {
            CreditLimitValidationsModel model = new CreditLimitValidationsModel();
            var outstandingbal = from d in context.TBL_LOAN
                                 where d.TBL_LOAN_APPLICATION_DETAIL.TBL_LOAN_APPLICATION.CUSTOMERGROUPID == customergroupId
        ...
        public async Task<CreditLimitValidationsModel> ValidateCreditLimitNPLByRMBM(short relationshipofficerId)
        {
            CreditLimitValidationsModel model = new CreditLimitValidationsModel();
            var outstandingbal = from d in context.TBL_LOAN
        ...
        public CreditLimitValidationsModel ValidateCreditLimitByRMBM(short staffId)
        {
            ...
            return new CreditLimitValidationsModel
            {
                ...
                limitString = (accountOfficerMaximumNPLExposure == 0) ? TranslateHelper.get("No limit") : string.Format("{0:#,0.00}", accountOfficerNPLLimit),
                nplExposure = accountOfficerNPLExposure,
                maximumAllowedLimit = (decimal)accountOfficerMaximumNPLExposure
            };
        }

        public async Task<IEnumerable<ObligorLimitViewModel>> GetAllObligorLimit()
        {
            var risk = await (from a in context.TBL_CUSTOMER_RISK_RATING
        ...
        public async Task<bool> AddUpdateRiskRating(ObligorLimitViewModel entity)
        {
            if (entity != null)
            {
                try
                {
                    ...
                    {
                        riskRating = await context.TBL_CUSTOMER_RISK_RATING.FindAsync(entity.riskRatingId);
                        if (entity != null)
                        {
                            ...
                            riskRating.CLASSIFICATION = entity.classification;
                        }
        ...
        public async Task<IEnumerable<CurrencyLimitViewModel>> GetAllCurrencyLimit()
        {
            var currencyLimits = await (from a in context.TBL_CURRENCY_LIMIT
        ...
        public async Task<bool> AddCurrencyLimits(CurrencyLimitViewModel entity)
        {
            if (entity != null)
            {
        ...
        public async Task<bool> UpdateCurrencyLimits(CurrencyLimitViewModel entity)
        {
            if (entity != null)
            {
                try
                {
                    ...
                    {
                        currencyLimit = await context.TBL_CURRENCY_LIMIT.FindAsync(entity.currencyLimitId);
                        if (currencyLimit != null)
                        {
        ...
        public async Task<bool> DeleteCurrencyLimit(int id, UserInfo user)
        {
            var response = 0;
            var currencyLimit = await context.TBL_CURRENCY_LIMIT.FindAsync(id);
        ...
        public async Task<IEnumerable<GroupLimitViewModel>> GetAllGroupLimit()
        {
            var groupLimits = await (from a in context.TBL_GROUP_LIMIT
                                     where a.DELETED == false
        ...
        public async Task<bool> AddGroupLimits(GroupLimitViewModel entity)
        {
            if (entity != null)
            {
                try
        ...
        public async Task<bool> UpdateGroupLimits(GroupLimitViewModel entity)
        {
            if (entity != null)
            {
                try
                {
                    ...
                    {
                        groupLimit = await context.TBL_GROUP_LIMIT.FindAsync(entity.groupLimitId);
                        if (groupLimit != null)
                        {
        ...
        public async Task<bool> DeleteGroupLimit(int id, UserInfo user)
        {
            var response = 0;
            var groupLimit = await context.TBL_GROUP_LIMIT.FindAsync(id);
        ...
        public async Task<bool> DeleteRiskRating(int id, UserInfo user)
        {
            var response = 0;
            var rating = await context.TBL_CUSTOMER_RISK_RATING.FindAsync(id);
        ...
        public async Task<bool> UpdateCustomerRating(ObligorLimitViewModel entity)
        {
        ...
        public async Task<bool> UpdateApplicationCustomerRating(ObligorLimitViewModel entity)
        {
            if (entity.scenerio == 1)
            {
                var appl = await context.TBL_LOAN_APPLICATION.FirstOrDefaultAsync(x => x.LOANAPPLICATIONID == entity.applicationId);
                appl.RISKRATINGID = (short?)entity.riskRatingId;
            }

            if (entity.scenerio == 2)
            {
                var lmra = await context.TBL_LMSR_APPLICATION.FirstOrDefaultAsync(x => x.LOANAPPLICATIONID == entity.applicationId);
                lmra.RISKRATINGID = (short?)entity.riskRatingId;
            }

            if (entity.customerId != null)
            {
                var singleCustomer = await context.TBL_CUSTOMER.FindAsync(entity.customerId);
                singleCustomer.RISKRATINGID = (short?)entity.riskRatingId;
            }

            if (entity.customerGroupId != null)
            {
                var groupCustomer = await context.TBL_CUSTOMER_GROUP.FindAsync(entity.customerGroupId);
        ...
        public async Task<TotalExposureLimit> GetTotalExposureLimit(ExposureLimitRequestModel model)
        {
            ...
            if (staffId != null)
            {
                outstandingLoan = await (from d in context.TBL_LOAN
                                         where d.LOANSTATUSID == (short)LoanStatusEnum.Active &&
                                         (d.RELATIONSHIPOFFICERID == staffId || d.RELATIONSHIPMANAGERID == staffId)
                                         select (decimal?)d.OUTSTANDINGPRINCIPAL).SumAsync() ?? 0;

                outstandingRevolving = await (from d in context.TBL_LOAN_REVOLVING
                                              where d.LOANSTATUSID == (short)LoanStatusEnum.Active &&
                                              (d.RELATIONSHIPOFFICERID == staffId || d.RELATIONSHIPMANAGERID == staffId)
                                              select (decimal?)d.OVERDRAFTLIMIT).SumAsync() ?? 0;

                result.AccountOfficerNPLExposure = outstandingLoan + outstandingRevolving;

                var officer = await context.TBL_STAFF.FirstOrDefaultAsync(a => a.STAFFID == staffId);
            ...
            if (branchId != null)
            {
                outstandingLoan = await (from a in context.TBL_LOAN
                                         ...
                                         select (decimal?)a.OUTSTANDINGPRINCIPAL).SumAsync() ?? 0;

                outstandingRevolving = await (from a in context.TBL_LOAN_REVOLVING
                                              where a.LOANSTATUSID == (short)LoanStatusEnum.Active && a.BRANCHID == branchId &&
                                              a.EXT_PRUDENT_GUIDELINE_STATUSID != (int)LoanPrudentialStatusEnum.Performing
                                              select (decimal?)a.OVERDRAFTLIMIT).SumAsync() ?? 0;

                result.BranchNPLExposure = outstandingLoan + outstandingRevolving;

                var branch = await context.TBL_BRANCH.FirstOrDefaultAsync(a => a.BRANCHID == branchId);
            ...
            var facilities = await context.TBL_LOAN_APPLICATION_DETAIL.Where(x => x.DELETED == false && x.STATUSID == (int)ApprovalStatusEnum.Approved && x.LOANAPPLICATIONID == model.applicationId).ToListAsync();
            ...
            foreach (var facility in facilities)
            {
                ...
                if (sectorId != null)
                {
                    ...
                    var sector = await context.TBL_SUB_SECTOR.FirstOrDefaultAsync(a => a.SECTORID == sectorId);
                ...
                if (customerId != null)
                {
                    ...
                    var bank = await (from a in context.TBL_CUSTOMER
                                      join b in context.TBL_CUSTOMER_RISK_RATING on a.RISKRATINGID equals b.RISKRATINGID
                                      where a.CUSTOMERID == customerId && a.DELETED == false
                                      select b
                                                     ).FirstOrDefaultAsync();
            ...
            var initiated = await (from a in context.TBL_LOAN_APPLICATION
                                   join d in context.TBL_LOAN_APPLICATION_DETAIL on a.LOANAPPLICATIONID equals d.LOANAPPLICATIONID
                                   where d.STATUSID == (short)ApprovalStatusEnum.Approved && a.APPROVEDDATE == null
                                   select (decimal?)d.APPROVEDAMOUNT).SumAsync() ?? 0;

            var approved = await (from a in context.TBL_LOAN_APPLICATION
                                  join d in context.TBL_LOAN_APPLICATION_DETAIL on a.LOANAPPLICATIONID equals d.LOANAPPLICATIONID
                                  where d.STATUSID == (short)ApprovalStatusEnum.Approved && a.APPROVEDDATE != null &&
                                  (a.APPLICATIONSTATUSID != (int)LoanApplicationStatusEnum.BookingRequestCompleted &&
                                  a.APPLICATIONSTATUSID != (int)LoanApplicationStatusEnum.BookingRequestInitiated)
        ...
        public bool SectorLimitExceeded(int sectorId, decimal applicationAmount)
        {
            ...
            if (countryCode == "ZMW" || countryCode == "GHS")
            {
                sectorLimit = context.TBL_SECTOR_GLOBAL_LIMIT.Where(s => s.CBNSECTORID == sectorCode.CODE).Select(s => s.THRESHOLDLIMIT).FirstOrDefault();
            }
        ...
        public async Task<TotalExposureLimit> GetTotalExposureLimitReference(string reference, int companyId)
        {
            var appl = await context.TBL_LOAN_APPLICATION.FirstOrDefaultAsync(x => x.APPLICATIONREFERENCENUMBER == reference);

            if (appl == null) return new TotalExposureLimit();

            return await GetTotalExposureLimit(new ExposureLimitRequestModel
            {
                companyId = companyId,
        ...
        public async Task<IEnumerable<ProjectRiskRatingCategoryViewModel>> getAllProjectRiskRatingCategories()
        {
            var categories = await (from a in context.TBL_PROJECT_RISK_RATING_CATEGORY
        ...
        public async Task<IEnumerable<ContractorCriteriaViewModel>> getAllCriteriaList()
        {
            var categories = await (from a in context.TBL_CONTRACTOR_CRITERIA
        ...
        public async Task<bool> AddContractorCriteria(ContractorCriteriaViewModel entity)
        {
            if (entity != null)
            {
                try
        ...
        public async Task<bool> AddContractorCriteriaOption(ContractorCriteriaOptionViewModel entity)
        {
            if (entity != null)
            {
                try
        ...
        public async Task<bool> UpdateContractorCriteria(ContractorCriteriaViewModel entity)
        {
            if (entity != null)
            {
                try
                {
                    ...
                    {
                        _CRITERIA = await context.TBL_CONTRACTOR_CRITERIA.FindAsync(entity.criteriaId);
                        if (_CRITERIA != null)
                        {
        ...
        public async Task<bool> UpdateContractorCriteriaOption(ContractorCriteriaOptionViewModel entity)
        {
            if (entity != null)
            {
                try
                {
                    ...
                    if (entity.criteriaId > 0)
                    {
                        _CRITERIA = await context.TBL_CONTRACTOR_CRITERIA_OPTION.FindAsync(entity.optionId);
                        if (_CRITERIA != null)
                        {
        ...
        public async Task<bool> AddProjectRiskCriteria(ProjectRiskRatingCriteriaViewModel entity)
        {
            if (entity != null)
            {
                try
        ...
        public async Task<bool> UpdateProjectRiskCriteria(ProjectRiskRatingCriteriaViewModel entity)
        {
            if (entity != null)
            {
                try
                {
                    ...
                    {
                        tBL_PROJECT_RISK = await context.TBL_PROJECT_RISK_RATING_CRITERIA.FindAsync(entity.projectRiskRatingCriteriaId);
        ...
        public async Task<bool> AddProjectRiskCategory(ProjectRiskRatingCategoryViewModel entity)
        {
            if (entity != null)
            {
                try
        ...
        public async Task<bool> UpdateProjectRiskCategory(ProjectRiskRatingCategoryViewModel entity)
        {
            if (entity != null)
            {
                try
                {
                    ...
                    {
                        tBL_PROJECT_RISK = await context.TBL_PROJECT_RISK_RATING_CATEGORY.FindAsync(entity.categoryId);
                        if (tBL_PROJECT_RISK != null)
                        {
        ...
        public async Task<IEnumerable<ContractorCriteriaOptionViewModel>> getAllContractorCriteriaOption()
        {
            var contractorCriteria = await (from a in context.TBL_CONTRACTOR_CRITERIA_OPTION
        ...
        public async Task<IEnumerable<ContractorTieringViewModel>> getContractorTieringByApplication(int loanApplicationId, int customerId)
        {
            var contractorTiering = await (from a in context.TBL_CONTRACTOR_TIERING
        ...
        public async Task<IEnumerable<ContractorTieringViewModel>> getContractorTieringByApplicationAndCustomer(int loanApplicationId, int customerId)
        {
        ...
        public async Task<IEnumerable<ContractorCriteriaViewModel>> getContractorTieringForEdit(int contractorTieringId)
        {
            var contractorTiering = await context.TBL_CONTRACTOR_TIERING.FindAsync(contractorTieringId);
            var contractorCriteria = await (from a in context.TBL_CONTRACTOR_CRITERIA
        ...
        public async Task<IEnumerable<ProjectRiskRatingCriteriaViewModel>> getAllProjectRiskRatingCriteria()
        {

            return await (from a in context.TBL_PROJECT_RISK_RATING_CRITERIA
        ...
        public async Task<IEnumerable<ProjectRiskRatingCategoryViewModel>> getAllProjectRiskRatingByCategories()
        {
            var projectRiskRatingCriteria = await (from a in context.TBL_PROJECT_RISK_RATING_CATEGORY
        ...
        public async Task<IEnumerable<ProjectRiskRatingViewModel>> getProjectRiskRatingByApplicationDetailId(int loanApplicationId, int loanApplicationDetailId, int loanBookingRequestId)
        {
            var projectRiskrating = await (from a in context.TBL_PROJECT_RISK_RATING
        ...
        public async Task<IEnumerable<ProjectRiskRatingViewModel>> getProjectRiskRatingByApplicationAndApplicationDetailId(int loanApplicationId, int loanApplicationDetailId)
        {
            var customerTier1 = await context.TBL_CONTRACTOR_TIERING.Where(d => d.LOANAPPLICATIONID == loanApplicationId).ToListAsync();
